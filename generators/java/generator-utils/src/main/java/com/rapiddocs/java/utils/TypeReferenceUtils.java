...
public class TypeReferenceUtils {
    ...
    public static class TypeReferenceIsOptional implements com.rapiddocs.ir.model.types.TypeReference.Visitor<Boolean> {
        ...
        @Override
        public Boolean visitContainer(com.rapiddocs.ir.model.types.ContainerType container) {
