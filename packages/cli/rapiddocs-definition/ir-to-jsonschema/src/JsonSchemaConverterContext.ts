...
import { IntermediateRepresentation, TypeDeclaration, TypeId, TypeReference } from "@khulnasoft/ir-sdk";
...
export class JsonSchemaConverterContext {
    ...
    public getDefinitionKey(typeDeclaration: TypeDeclaration): string {
        return [
            ...typeDeclaration.name.rapiddocsFilepath.allParts.map((part) => part.originalName),
