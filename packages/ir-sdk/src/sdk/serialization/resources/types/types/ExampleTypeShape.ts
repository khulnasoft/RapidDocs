...
export const ExampleTypeShape: core.serialization.Schema<serializers.ExampleTypeShape.Raw, RapiddocsIr.ExampleTypeShape> =
    core.serialization
        .union("type", {
        ...
        .transform<RapiddocsIr.ExampleTypeShape>({
            transform: (value) => {
                switch (value.type) {
                    case "alias":
                        return RapiddocsIr.ExampleTypeShape.alias(value);
                    case "enum":
                        return RapiddocsIr.ExampleTypeShape.enum(value);
                    case "object":
                        return RapiddocsIr.ExampleTypeShape.object(value);
                    case "union":
                        return RapiddocsIr.ExampleTypeShape.union(value);
                    case "undiscriminatedUnion":
                        return RapiddocsIr.ExampleTypeShape.undiscriminatedUnion(value);
                    default:
                        return value as RapiddocsIr.ExampleTypeShape;
                }
            },
