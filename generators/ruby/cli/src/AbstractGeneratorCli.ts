    ...
    public async run(pathToConfig: string): Promise<void> {
        ...
        try {
            ...
            await config.output.mode._visit<void | Promise<void>>({
                ...
                github: async (githubOutputMode: RapiddocsGeneratorExec.GithubOutputMode) => {
            ...
            await generatorNotificationService.sendUpdate(
                RapiddocsGeneratorExec.GeneratorUpdate.exitStatusUpdate(RapiddocsGeneratorExec.ExitStatusUpdate.successful({}))
            );
        } catch (e) {
            await generatorNotificationService.sendUpdate(
