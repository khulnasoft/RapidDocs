...
export const PrimitiveTypeV2: core.serialization.Schema<serializers.PrimitiveTypeV2.Raw, RapiddocsIr.PrimitiveTypeV2> =
    core.serialization
        .union("type", {
            integer: IntegerType,
            long: LongType,
        ...
        .transform<RapiddocsIr.PrimitiveTypeV2>({
            transform: (value) => {
                switch (value.type) {
                    case "integer":
                        return RapiddocsIr.PrimitiveTypeV2.integer(value);
                    case "long":
                        return RapiddocsIr.PrimitiveTypeV2.long(value);
                    case "uint":
                        return RapiddocsIr.PrimitiveTypeV2.uint(value);
                    case "uint64":
                        return RapiddocsIr.PrimitiveTypeV2.uint64(value);
                    case "float":
                        return RapiddocsIr.PrimitiveTypeV2.float(value);
                    case "double":
                        return RapiddocsIr.PrimitiveTypeV2.double(value);
                    case "boolean":
                        return RapiddocsIr.PrimitiveTypeV2.boolean(value);
                    case "string":
                        return RapiddocsIr.PrimitiveTypeV2.string(value);
                    case "date":
                        return RapiddocsIr.PrimitiveTypeV2.date(value);
                    case "dateTime":
                        return RapiddocsIr.PrimitiveTypeV2.dateTime(value);
                    case "uuid":
                        return RapiddocsIr.PrimitiveTypeV2.uuid(value);
                    case "base64":
                        return RapiddocsIr.PrimitiveTypeV2.base64(value);
                    case "bigInteger":
                        return RapiddocsIr.PrimitiveTypeV2.bigInteger(value);
                    default:
                        return value as RapiddocsIr.PrimitiveTypeV2;
                }
            },
