...
from rapiddocs_python.codegen import AST, ClassParent, LocalClassReference, SourceFile
from rapiddocs_python.external_dependencies import Pydantic, PydanticVersionCompatibility
...
class PydanticModel:
    ...
    def add_field(self, unsanitized_field: PydanticField) -> None:
        ...
        # Rapiddocs will automatically add the underscore in the beginning for fields
