...
[![pypi](https://img.shields.io/pypi/v/rapiddocs_bearer-token-environment-variable)](https://pypi.python.org/pypi/rapiddocs_bearer-token-environment-variable)
...
```sh
pip install rapiddocs_bearer-token-environment-variable
```
