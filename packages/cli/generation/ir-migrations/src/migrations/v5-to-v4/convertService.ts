...
function convertDeclaredServiceName(
    ...
    return {
        ...
        rapiddocsFilepath: convertRapiddocsFilepathV1(serviceName.rapiddocsFilepath),
        rapiddocsFilepathV2: convertRapiddocsFilepathV2(serviceName.rapiddocsFilepath)
    };
}
...
function convertDeclaredErrorName(
    ...
    return {
        ...
        rapiddocsFilepath: convertRapiddocsFilepathV1(errorName.rapiddocsFilepath),
        rapiddocsFilepathV2: convertRapiddocsFilepathV2(errorName.rapiddocsFilepath)
    };
}
