...
import { AbstractGeneratorContext, RapiddocsGeneratorExec, GeneratorNotificationService } from "@khulnasoft/base-generator";
...
> extends AbstractGeneratorContext {
    ...
    public publishConfig: RapiddocsGeneratorExec.NugetGithubPublishInfo | undefined;
        ...
        if (this.allNamespaceSegments == null) {
            this.allNamespaceSegments = new Set(
                Object.values(this.ir.subpackages).flatMap((subpackage) =>
                    this.getFullNamespaceSegments(subpackage.rapiddocsFilepath)
                )
            );
        }
    ...
    public getNamespaceFromRapiddocsFilepath(rapiddocsFilepath: RapiddocsFilepath): string {
        return this.getFullNamespaceSegments(rapiddocsFilepath).join(".");
    }

    abstract getChildNamespaceSegments(rapiddocsFilepath: RapiddocsFilepath): string[];

    public getFullNamespaceSegments(rapiddocsFilepath: RapiddocsFilepath): string[] {
        return [this.getNamespace(), ...this.getChildNamespaceSegments(rapiddocsFilepath)];
    }
