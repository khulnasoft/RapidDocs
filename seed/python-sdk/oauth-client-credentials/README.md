...
[![pypi](https://img.shields.io/pypi/v/rapiddocs_oauth-client-credentials)](https://pypi.python.org/pypi/rapiddocs_oauth-client-credentials)
...
```sh
pip install rapiddocs_oauth-client-credentials
```
