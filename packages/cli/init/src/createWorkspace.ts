...
import { formatDefinitionFile } from "@khulnasoft/rapiddocs-definition-formatter";
import { RootApiFileSchema } from "@khulnasoft/rapiddocs-definition-schema";
...
export async function createRapiddocsWorkspace({
...
async function getDefaultGeneratorsConfiguration({
    ...
    const defaultGeneratorName = "rapiddocsapi/rapiddocs-typescript-node-sdk";
