import { Scope, Severity } from "@khulnasoft/browser-compatible-base-generator";
...
const STRING_TYPE_REFERENCE: RapiddocsIr.dynamic.TypeReference = {
    type: "primitive",
    value: "STRING"
};
...
export class EndpointSnippetGenerator {
    ...
    private getConstructorOAuthArgs({
        ...
        auth: RapiddocsIr.dynamic.OAuth;
        values: RapiddocsIr.dynamic.OAuthValues;
    }): ts.ObjectField[] {
        return [
            {
