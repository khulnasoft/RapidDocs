...
import (
	context "context"
	fmt "fmt"
	fixtures "github.com/khulnasoft/rapiddocs-go/internal/testdata/sdk/upload/fixtures"
	core "github.com/khulnasoft/rapiddocs-go/internal/testdata/sdk/upload/fixtures/core"
	internal "github.com/khulnasoft/rapiddocs-go/internal/testdata/sdk/upload/fixtures/internal"
	option "github.com/khulnasoft/rapiddocs-go/internal/testdata/sdk/upload/fixtures/option"
	io "io"
	http "net/http"
)
...
func (c *Client) Upload(
	...
	if err := writer.WriteField("rapiddocs", fmt.Sprintf("%v", "rapiddocs")); err != nil {
		return "", err
	}
