...
[![pypi](https://img.shields.io/pypi/v/rapiddocs_oauth-client-credentials-environment-variables)](https://pypi.python.org/pypi/rapiddocs_oauth-client-credentials-environment-variables)
...
```sh
pip install rapiddocs_oauth-client-credentials-environment-variables
```
