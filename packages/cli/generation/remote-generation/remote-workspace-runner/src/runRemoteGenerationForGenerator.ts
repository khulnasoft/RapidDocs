...
import { Audiences, rapiddocsConfigJson, generatorsYml } from "@khulnasoft/configuration";
...
import { RapiddocsIr } from "@khulnasoft/ir-sdk";
import { convertIrToFdrApi } from "@khulnasoft/register";
import { InteractiveTaskContext } from "@khulnasoft/task-context";
import { RapiddocsWorkspace, IdentifiableSource } from "@khulnasoft/workspace-loader";

import { RapiddocsRegistry as FdrAPI, RapiddocsRegistryClient as FdrClient } from "@rapiddocs-rapiddocs/fdr-cjs-sdk";
...
function getPublishConfig({
    ...
    generatorInvocation: generatorsYml.GeneratorInvocation;
}): RapiddocsIr.PublishingConfig | undefined {
        ...
        publishV2: (value) =>
            value._visit({
                ...
                postman: (value) => {
                    ...
                    return RapiddocsIr.PublishingConfig.direct({
                        target: RapiddocsIr.PublishTarget.postman({
                            apiKey: value.apiKey,
