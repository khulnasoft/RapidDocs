...
import { RapiddocsRegistryClient as FdrClient, RapiddocsRegistry } from "@rapiddocs-rapiddocs/generators-sdk";
...
function convertGeneratorType(generatorType: GeneratorType): RapiddocsRegistry.generators.GeneratorType {
