...
import { EndpointExample, EndpointWithExample } from "@khulnasoft/openapi-ir";

import { getSchemaIdFromReference } from "../../../../schema/convertSchemas";
import { isReferenceObject } from "../../../../schema/utils/isReferenceObject";
import { AbstractOpenAPIV3ParserContext } from "../../AbstractOpenAPIV3ParserContext";
import { RapiddocsStreamingExtension, StreamConditionEndpoint } from "../../extensions/getRapiddocsStreamingExtension";
...
export function convertStreamingOperation({
    ...
    streamingExtension: RapiddocsStreamingExtension;
    ...
    const requestBodySchemaWithLiteralProperty: OpenAPIV3.SchemaObject = {
        ...
        properties: {
            ...
            [streamingExtension.streamConditionProperty]: {
                type: "boolean",
                "x-rapiddocs-boolean-literal": isStreaming,
                ...(streamingProperty ?? {})
...
export function isStreamingExample(
    ...
    return example._visit({
        unknown: (unknownExample) => {
            const maybeRapiddocsExample = RawSchemas.serialization.ExampleEndpointCallSchema.parse(unknownExample);
            if (!maybeRapiddocsExample.ok) {
                return undefined;
            }

            if (maybeRapiddocsExample.value.response == null) {
                return undefined;
            }

            return (maybeRapiddocsExample.value.response as { stream?: unknown }).stream != null;
        },
        full: () => undefined,
        _other: () => undefined
    });
