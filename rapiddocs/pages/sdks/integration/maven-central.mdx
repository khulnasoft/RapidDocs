...
To make your Java SDK publicly accessible, publish to [Maven Central](https://central.sonatype.com/). Once you've followed the steps below to connect your Maven account to your SDK, Rapiddocs will automatically publish the latest version of your SDK.  
...
You'll need to store two repository secrets in your **rapiddocs configuration repository** (**i.e. not the Java SDK repository**),
...
You'll need to store repository secrets in your **rapiddocs configuration repository**,
