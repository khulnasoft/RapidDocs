...
[![pypi](https://img.shields.io/pypi/v/rapiddocs_response-property)](https://pypi.python.org/pypi/rapiddocs_response-property)
...
```sh
pip install rapiddocs_response-property
```
