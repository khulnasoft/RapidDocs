...
description: The api.yml file contains general API configuration when using the Rapiddocs Definition format.
---

A `rapiddocs/` folder has a special file called `api.yml`, which includes all the API-wide configuration.
