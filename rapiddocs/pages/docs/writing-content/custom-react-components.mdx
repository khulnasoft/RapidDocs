...
You can extend Rapiddocs's built-in component library by adding your own custom React components. 
...
/>
  ...
  Add your components directory to `docs.yml` so that the Rapiddocs CLI can scan your components directory 
...
While you can bundle React components as custom JavaScript, using Rapiddocs's built-in React component support provides several key advantages:
