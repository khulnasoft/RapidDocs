...
export class TypeGenerator<Context extends BaseContext = BaseContext> {
    ...
    public generateType({
        ...
        return Type._visit<GeneratedType<Context>>(shape, {
            union: (shape) =>
                this.generateUnion({ typeName, shape, examples, docs, rapiddocsFilepath, getReferenceToSelf, inline }),
            ...
            object: (shape) =>
                this.generateObject({ typeName, shape, examples, docs, rapiddocsFilepath, getReferenceToSelf }),
            enum: (shape) => this.generateEnum({ typeName, shape, examples, docs, rapiddocsFilepath, getReferenceToSelf }),
            alias: (shape) =>
                this.generateAlias({
                    typeName,
