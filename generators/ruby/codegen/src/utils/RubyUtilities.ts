...
import { BasicLicense, CustomLicense } from "@rapiddocs-rapiddocs/generator-exec-sdk/api";
...
export function getBreadcrumbsFromFilepath(
    ...
    return [
        clientName,
        ...(includeFullPath === true ? rapiddocsFilepath.allParts : rapiddocsFilepath.packagePath).map(
...
export function generateGemspec(
    ...
    sdkVersion?: string,
    licenseConfig?: RapiddocsGeneratorExec.LicenseConfig,
...
// users are encouraged to rapiddocsignore and update, while allowing the traditional gemspec to remain generated
