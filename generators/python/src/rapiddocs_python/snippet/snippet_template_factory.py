...
from rapiddocs.generator_exec import GeneratorUpdate, LogLevel, LogUpdate

from rapiddocs_python.codegen import AST
from rapiddocs_python.codegen.imports_manager import ImportsManager
from rapiddocs_python.codegen.project import Project
from rapiddocs_python.generator_exec_wrapper import GeneratorExecWrapper
from rapiddocs_python.generators.pydantic_model.type_declaration_handler.enum_generator import (
    EnumSnippetGenerator,
)
from rapiddocs_python.generators.pydantic_model.type_declaration_handler.pydantic_models.pydantic_model_simple_discriminated_union_generator import (
    PydanticModelDiscriminatedUnionSnippetGenerator,
)
from rapiddocs_python.generators.pydantic_model.type_declaration_handler.typeddicts.typeddict_simple_discriminated_union_generator import (
    TypeddictDiscriminatedUnionSnippetGenerator,
)
from rapiddocs_python.generators.sdk.client_generator.endpoint_function_generator import (
    get_endpoint_name,
    get_parameter_name,
)
from rapiddocs_python.generators.sdk.client_generator.generated_root_client import (
    GeneratedRootClient,
)
from rapiddocs_python.generators.sdk.client_generator.request_body_parameters.bytes_request_body_parameters import (
    BytesRequestBodyParameters,
)
from rapiddocs_python.generators.sdk.client_generator.request_body_parameters.file_upload_request_body_parameters import (
    FileUploadRequestBodyParameters,
)
from rapiddocs_python.generators.sdk.client_generator.request_body_parameters.inlined_request_body_parameters import (
    InlinedRequestBodyParameters,
)
from rapiddocs_python.generators.sdk.client_generator.request_body_parameters.referenced_request_body_parameters import (
...
from rapiddocs_python.snippet.template_utils import TEMPLATE_SENTINEL
...
class SnippetTemplateFactory:
    ...
    def _get_subpackage_client_accessor(
        ...
        components = rapiddocs_filepath.package_path.copy()
        if rapiddocs_filepath.file is not None:
            components += [rapiddocs_filepath.file]
        if len(components) == 0:
            return ""
    ...
    def generate_templates(self) -> List[SnippetRegistryEntry]:
        ...
        for service in self._ir.services.values():
            rapiddocs_filepath = service.name.rapiddocs_filepath
            package_path = self._get_subpackage_client_accessor(rapiddocs_filepath)
