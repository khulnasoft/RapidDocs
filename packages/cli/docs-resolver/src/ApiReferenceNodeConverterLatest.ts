...
import { FdrAPI, RapiddocsNavigation } from "@khulnasoft/fdr-sdk";
...
export class ApiReferenceNodeConverterLatest {
    ...
    #convertPackage(
        ...
        if (subpackage != null) {
            ...
            const subpackageNode: RapiddocsNavigation.V1.ApiPackageNode = {
                id: subpackageNodeId,
                type: "apiPackage",
            ...
            const sectionNode: RapiddocsNavigation.V1.ApiPackageNode = {
    ...
    #createSubpackageNode(
        ...
        parentSlug: RapiddocsNavigation.V1.SlugGenerator
    ): RapiddocsNavigation.V1.ApiPackageNode | undefined {
        const slug = RapiddocsNavigation.V1.SlugGenerator.init(parentSlug.get()).apply({
            urlSlug: kebabCase(metadata.name)
        });
        const children = this.#convertApiDefinitionPackageId(subpackageId, slug);

        const node: RapiddocsNavigation.V1.ApiPackageNode = {
    ...
    >(
        ...
        itemNode: Exclude<
            RapiddocsNavigation.V1.ApiPackageChild,
            RapiddocsNavigation.V1.EndpointPairNode | RapiddocsNavigation.V1.PageNode | RapiddocsNavigation.V1.LinkNode
        >,
        parentSlug: RapiddocsNavigation.V1.SlugGenerator,
        additionalChildren: RapiddocsNavigation.V1.ApiPackageChild[]
    ) {
    ...
    #addEndpointToHierarchy(
        ...
        const endpointNode: RapiddocsNavigation.V1.EndpointNode = {
    ...
    #addWebSocketToHierarchy(
        ...
        const webSocketNode: RapiddocsNavigation.V1.WebSocketNode = {
    ...
    #addWebhookToHierarchy(
        ...
        const webhookNode: RapiddocsNavigation.V1.WebhookNode = {
