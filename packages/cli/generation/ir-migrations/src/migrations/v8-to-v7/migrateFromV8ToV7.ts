...
function convertRapiddocsFilepath(rapiddocsFilepath: IrVersions.V8.commons.RapiddocsFilepath): IrVersions.V7.commons.RapiddocsFilepath {
    return rapiddocsFilepath.allParts;
}
...
function convertDeclaredTypeName(typeName: IrVersions.V8.types.DeclaredTypeName): IrVersions.V7.types.DeclaredTypeName {
    return {
        name: typeName.name,
        rapiddocsFilepath: convertRapiddocsFilepath(typeName.rapiddocsFilepath)
    };
}
...
function convertDeclaredErrorName(
    ...
    return {
        name: name.name,
        rapiddocsFilepath: convertRapiddocsFilepath(name.rapiddocsFilepath)
    };
}
...
function convertHttpService(service: IrVersions.V8.http.HttpService): IrVersions.V7.http.HttpService {
    return {
        ...
        name: {
            rapiddocsFilepath: convertRapiddocsFilepath(service.name.rapiddocsFilepath)
        },
