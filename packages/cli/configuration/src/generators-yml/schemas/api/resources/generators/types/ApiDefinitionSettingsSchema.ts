...
export interface ApiDefinitionSettingsSchema {
    /**
     * Whether to use the titles of the schemas within an OpenAPI definition as the names of the types within Rapiddocs. Defaults to true.
     ...
     */
    unions?: RapiddocsDefinition.UnionSettingsSchema;
