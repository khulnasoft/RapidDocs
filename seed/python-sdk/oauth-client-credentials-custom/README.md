...
[![pypi](https://img.shields.io/pypi/v/rapiddocs_oauth-client-credentials-custom)](https://pypi.python.org/pypi/rapiddocs_oauth-client-credentials-custom)
...
```sh
pip install rapiddocs_oauth-client-credentials-custom
```
