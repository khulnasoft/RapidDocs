...
1. Ensure you have a paid Rapiddocs subscription
2. Contact support to request HTTP snippets activation
3. Once enabled, build your production docs

<Note>
Currently, HTTP snippets are provided as an all-or-nothing set. You cannot configure which languages are displayed. If you would like this feature, please [open a GitHub issue](https://github.com/khulnasoft/rapiddocs/issues/new?template=docs-feature.yml).
</Note>
...
- For Rapiddocs Definition: Follow the [examples documentation](/learn/api-definition/rapiddocs/examples)
