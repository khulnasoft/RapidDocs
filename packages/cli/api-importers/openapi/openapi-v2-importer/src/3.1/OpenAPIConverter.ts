...
import { AuthScheme, RapiddocsIr, HttpEndpoint, IntermediateRepresentation } from "@khulnasoft/ir-sdk";
import { constructHttpPath, injectAutogeneratedExamples } from "@khulnasoft/ir-utils";

import { AbstractConverter } from "../AbstractConverter";
import { ErrorCollector } from "../ErrorCollector";
import { RapiddocsIgnoreExtension } from "../extensions/x-rapiddocs-ignore";
...
export class OpenAPIConverter extends AbstractConverter<OpenAPIConverterContext3_1, IntermediateRepresentation> {
    ...
    constructor({ breadcrumbs, context }: OpenAPIConverter.Args) {
        ...
        this.ir = {
            auth: {
                docs: undefined,
                requirement: RapiddocsIr.AuthSchemesRequirement.All,
                schemes: []
            },
            types: {},
            services: {},
            ...
            basePath: undefined,
            pathParameters: [],
            errorDiscriminationStrategy: RapiddocsIr.ErrorDiscriminationStrategy.statusCode(),
            variables: [],
    ...
    public async convert({
        ...
        context.spec = this.removeXRapiddocsIgnores({
    ...
    private removeXRapiddocsIgnores({
        document,
        context,
        errorCollector,
        breadcrumbs = []
        ...
        if (Array.isArray(document)) {
            return document
                .filter((item, index) => {
                    const shouldIgnore = new RapiddocsIgnoreExtension({
