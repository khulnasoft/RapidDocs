...
import { DocsLinks } from "@khulnasoft/configuration-loader";
import { EndpointResolverImpl, TypeResolverImpl, constructRootApiFileContext } from "@khulnasoft/ir-generator";
