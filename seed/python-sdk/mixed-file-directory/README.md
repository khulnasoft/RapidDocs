...
[![pypi](https://img.shields.io/pypi/v/rapiddocs_mixed-file-directory)](https://pypi.python.org/pypi/rapiddocs_mixed-file-directory)
...
```sh
pip install rapiddocs_mixed-file-directory
```
