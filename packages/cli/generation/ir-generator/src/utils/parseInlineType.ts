import { RawSchemas, recursivelyVisitRawTypeReference } from "@khulnasoft/rapiddocs-definition-schema";
...
export function createTypeReferenceParser(file: RapiddocsFileContext): TypeReferenceParser {
    return (type) => {
