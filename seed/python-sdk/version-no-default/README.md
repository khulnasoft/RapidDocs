...
[![pypi](https://img.shields.io/pypi/v/rapiddocs_version-no-default)](https://pypi.python.org/pypi/rapiddocs_version-no-default)
...
```sh
pip install rapiddocs_version-no-default
```
