...
import { AbstractProject, RapiddocsGeneratorExec, File, SourceFetcher } from "@khulnasoft/base-generator";
...
declare namespace CsProj {
    interface Args {
        name: string;
        version?: string;
        license?: RapiddocsGeneratorExec.LicenseConfig;
        githubUrl?: string;
        context: AbstractCsharpGeneratorContext<BaseCsharpCustomConfigSchema>;
...
class CsProj {
    private name: string;
    private license: RapiddocsGeneratorExec.LicenseConfig | undefined;
