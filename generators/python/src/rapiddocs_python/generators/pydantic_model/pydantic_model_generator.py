...
from rapiddocs_python.codegen import Project
...
class PydanticModelGenerator(AbstractGenerator):
    ...
    def _should_generate_typedict(self, context: PydanticGeneratorContext, type_: ir_types.Type) -> bool:
        return context.use_typeddict_requests and can_be_rapiddocs_model(type_, context.ir.types)
    ...
    def _build_snippet_writer(
        ...
        the rapiddocs_python.utils package. This is redeclared here to prevent an import
        cycle.
        """
        snippet_writer = SnippetWriter(
            context=context,
