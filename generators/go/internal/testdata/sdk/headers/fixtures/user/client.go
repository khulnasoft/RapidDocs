...
import (
	...
	fmt "fmt"
	fixtures "github.com/khulnasoft/rapiddocs-go/internal/testdata/sdk/headers/fixtures"
	core "github.com/khulnasoft/rapiddocs-go/internal/testdata/sdk/headers/fixtures/core"
	internal "github.com/khulnasoft/rapiddocs-go/internal/testdata/sdk/headers/fixtures/internal"
	option "github.com/khulnasoft/rapiddocs-go/internal/testdata/sdk/headers/fixtures/option"
	http "net/http"
	time "time"
)
...
func (c *Client) SetName(
	...
	headers.Add("X-Endpoint-Rapiddocs-Header", fmt.Sprintf("%v", "rapiddocs"))
