        ...
        const expectedViolations: ValidationViolation[] = [
            {
                ...
                message: "SDK method a.b already exists (x-rapiddocs-sdk-group-name: a, x-rapiddocs-sdk-method-name: b)"
            }
        ];
        ...
        const expectedViolations: ValidationViolation[] = [
            {
                ...
                relativeFilepath: RelativeFilePath.of("openapi/openapi.yml"),
                nodePath: ["paths", "/a/b", "get"],
                message: "SDK method a.b.c.d already exists (x-rapiddocs-sdk-group-name: a.b.c, x-rapiddocs-sdk-method-name: d)"
            }
        ];
