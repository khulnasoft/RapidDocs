...
import { EndpointId, FeatureId, RapiddocsFilepath, HttpEndpoint } from "@rapiddocs-rapiddocs/ir-sdk/api";
...
export class ReadmeSnippetBuilder extends AbstractReadmeSnippetBuilder {
    ...
    private buildUsageSnippets(): string[] {
        const usageEndpointIds = this.getEndpointIdsForFeature(RapiddocsGeneratorCli.StructuredFeatureId.Usage);
...
`)
    ...
    private getMethodCall(endpoint: EndpointWithFilepath): string {
        return `${this.context.getAccessFromRootClient(endpoint.rapiddocsFilepath)}.${this.context.getEndpointMethodName(
            endpoint.endpoint
        )}`;
    }
