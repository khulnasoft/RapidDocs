...
import { BaseContext, BrandedGeneratedAliasType } from "@rapiddocs-typescript/contexts";
import {
    ...
    implements BrandedGeneratedAliasType<Context>
{
    ...
    private getStringBrand(): string {
        return [...this.rapiddocsFilepath.packagePath.map((part) => part.camelCase.unsafeName), this.typeName].join("_");
    }
}
