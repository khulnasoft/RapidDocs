...
from rapiddocs_python.codegen.local_class_reference import LocalClassReference
from rapiddocs_python.external_dependencies.typing_extensions import (
...
class RapiddocsTypedDict:
    ...
    def __init__(
        ...
        self._class_declaration = AST.ClassDeclaration(
            ...
            extends=extends_crs or [RapiddocsTypedDict.TYPEDDICT_REFERENCE],
    ...
    def add_field(
        ...
        *,
        ...
        # Here to mirror the RapiddocsAwarePydanticModel.add_field method signature
    ...
    def __enter__(self) -> RapiddocsTypedDict:
        return self
    ...
    def can_type_id_be_typeddict(
        ...
        return can_be_rapiddocs_model(types[type_id].shape, types)
