...
Rapiddocs's SDKs support sending and receiving messages over WebSockets. You can specify 
your WebSocket API Definition by using [AsyncAPI](https://www.asyncapi.com/en) or 
the Rapiddocs Definition. 
...
```
    ...
    <Accordion title="Rapiddocs Definition">
      If you have a Rapiddocs Definition, you can specify your WebSocket in 
