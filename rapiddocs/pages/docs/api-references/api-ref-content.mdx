...
Rapiddocs Docs allows you to write Markdown content in your API Reference documentation. This feature is useful for providing additional context, examples, or explanations for your API endpoints. There are a few ways to accomplish this:
...
## In Rapiddocs Definition

If you're using Rapiddocs's simpler API definition format, you can include Markdown content in your API definition.
...
To add a summary page, create a Markdown file in your `rapiddocs/` folder and link to it in your `docs.yml` file:
...
To add Markdown content between endpoints, create a Markdown file in your `rapiddocs/` folder and link to it in your `docs.yml` file:
