import { AbstractFormatter, Scope, Severity } from "@khulnasoft/browser-compatible-base-generator";
...
const SNIPPET_IMPORT_PATH = "rapiddocs";
    ...
    private getInlinedRequestArg({
        ...
        return go.TypeInstantiation.structPointer({
            typeReference: go.typeReference({
                ...
                importPath: this.context.getImportPath(request.declaration.rapiddocsFilepath)
            }),
