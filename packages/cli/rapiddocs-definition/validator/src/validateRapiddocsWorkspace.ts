import { RapiddocsWorkspace, visitAllDefinitionFiles, visitAllPackageMarkers } from "@khulnasoft/api-workspace-commons";
import { GENERATORS_CONFIGURATION_FILENAME, ROOT_API_FILENAME, generatorsYml } from "@khulnasoft/configuration-loader";
...
export function validateRapiddocsWorkspace(workspace: RapiddocsWorkspace, logger: Logger): ValidationViolation[] {
