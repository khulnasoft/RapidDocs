...
from rapiddocs_python.codegen.ast.nodes.declarations.class_.class_declaration import (
    ClassDeclaration,
)
from rapiddocs_python.external_dependencies import Pydantic
from rapiddocs_python.external_dependencies.pydantic import PydanticVersionCompatibility
from rapiddocs_python.generators.pydantic_model.type_declaration_handler.type_utilities import (
...
from ...rapiddocs_aware_pydantic_model import RapiddocsAwarePydanticModel
...
class DiscriminatedUnionWithUtilsGenerator(AbstractTypeGenerator):
    ...
    def _add_conditional_base_methods(
        self, base_class: RapiddocsAwarePydanticModel, internal_single_union_types: List[LocalClassReference]
    ) -> AST.TypeHint:
            ...
            for single_union_type in self._union.types:
                with PydanticModel(
                    ...
                    if len(forward_refed_types) > 0:
                        ...
                        # RapiddocsAwarePydanticModel will automatically add the import constraint if the
