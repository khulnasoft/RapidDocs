...
import { visitRawApiAuth } from "@khulnasoft/rapiddocs-definition-schema";
import { AbsoluteFilePath, RelativeFilePath, dirname, join, resolve } from "@khulnasoft/fs-utils";
import { TaskContext } from "@khulnasoft/task-context";

import { RapiddocsFiddle } from "@rapiddocs-rapiddocs/fiddle-sdk";
import { GithubPullRequestReviewer, OutputMetadata, PublishingMetadata, PypiMetadata } from "@rapiddocs-rapiddocs/fiddle-sdk/api";
...
async function convertOutputMode({
        ...
        switch (mode) {
            ...
            case "release":
                return RapiddocsFiddle.OutputMode.githubV2(
                    RapiddocsFiddle.GithubOutputModeV2.commitAndRelease({
                        owner,
                        repo,
                        license,
                        publishInfo,
            ...
            case "pull-request": {
                ...
                return RapiddocsFiddle.OutputMode.githubV2(
                    RapiddocsFiddle.GithubOutputModeV2.pullRequest({
                        owner,
                        repo,
                        license,
                        publishInfo,
            ...
            case "push":
                return RapiddocsFiddle.OutputMode.githubV2(
                    RapiddocsFiddle.GithubOutputModeV2.push({
                        owner,
                        repo,
    ...
    if (generator.output == null) {
        return RapiddocsFiddle.remoteGen.OutputMode.publish({ registryOverrides: {} });
    }
    switch (generator.output.location) {
        case "local-file-system":
            return RapiddocsFiddle.OutputMode.downloadFiles({
                downloadSnippets
            });
        case "npm":
            return RapiddocsFiddle.OutputMode.publishV2(
                RapiddocsFiddle.remoteGen.PublishOutputModeV2.npmOverride({
        ...
        case "maven": {
            return RapiddocsFiddle.OutputMode.publishV2(
                RapiddocsFiddle.remoteGen.PublishOutputModeV2.mavenOverride({
        ...
        case "postman":
            return RapiddocsFiddle.OutputMode.publishV2(
                RapiddocsFiddle.remoteGen.PublishOutputModeV2.postman({
        ...
        case "pypi":
            return RapiddocsFiddle.OutputMode.publishV2(
                RapiddocsFiddle.remoteGen.PublishOutputModeV2.pypiOverride({
        ...
        case "nuget":
            return RapiddocsFiddle.OutputMode.publishV2(
                RapiddocsFiddle.remoteGen.PublishOutputModeV2.nugetOverride({
        ...
        case "rubygems":
            return RapiddocsFiddle.OutputMode.publishV2(
                RapiddocsFiddle.remoteGen.PublishOutputModeV2.rubyGemsOverride({
...
async function getGithubLicense({
...
}): Promise<RapiddocsFiddle.GithubLicense> {
    if (typeof githubLicense === "string") {
        switch (githubLicense) {
            case "MIT":
                return RapiddocsFiddle.GithubLicense.basic({
                    id: RapiddocsFiddle.GithubLicenseId.Mit
                });
            case "Apache-2.0":
                return RapiddocsFiddle.GithubLicense.basic({
                    id: RapiddocsFiddle.GithubLicenseId.Apache
                });
            default:
    ...
    return RapiddocsFiddle.GithubLicense.custom({
...
function getGithubPublishInfo(
    ...
    maybeGroupLevelMetadata: OutputMetadata | undefined,
    maybeTopLevelMetadata: OutputMetadata | undefined
): RapiddocsFiddle.GithubPublishInfo {
    switch (output.location) {
        ...
        case "postman":
            return RapiddocsFiddle.GithubPublishInfo.postman({
