...
import { AbstractGeneratorContext, getPackageName, getSdkVersion } from "@khulnasoft/base-generator";
import { TypesGenerator } from "@khulnasoft/rapiddocs-ruby-model";
...
import {
    ...
    getClientName,
    getGemName
} from "@khulnasoft/ruby-codegen";
import { AbstractGeneratorCli } from "@khulnasoft/ruby-generator-cli";

import { RapiddocsGeneratorExec } from "@rapiddocs-rapiddocs/generator-exec-sdk";
import { IntermediateRepresentation, ObjectProperty, TypeId } from "@rapiddocs-rapiddocs/ir-sdk/api";
...
export class RubySdkGeneratorCli extends AbstractGeneratorCli<RubySdkCustomConfigConsumed> {
    ...
    private generateRepositoryBoilerPlate(gemName: string, githubOutputMode: RapiddocsGeneratorExec.GithubOutputMode) {
    ...
    protected async publishPackage(
        _config: RapiddocsGeneratorExec.GeneratorConfig,
    ...
    protected async writeForGithub(
        ...
        generatorContext: AbstractGeneratorContext,
        intermediateRepresentation: IntermediateRepresentation,
        githubOutputMode: RapiddocsGeneratorExec.GithubOutputMode
    ): Promise<void> {
        ...
        const outputDir = AbsoluteFilePath.of("/rapiddocs/ruby_output");
