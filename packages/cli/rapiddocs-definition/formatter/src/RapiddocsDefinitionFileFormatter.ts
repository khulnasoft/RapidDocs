...
import { assertNever, assertNeverNoThrow } from "@khulnasoft/core-utils";
...
type RapiddocsFileCursorLocation =
...
export class RapiddocsDefinitionFileFormatter {
    ...
    public async format(): Promise<string> {
        if (this.formatted == null) {
            ...
            let location: RapiddocsFileCursorLocation = "unknown";
            while (!reader.isEof()) {
    ...
    private writeNextLine({
        ...
        nextLine: string;
        writer: FileWriter;
        location: RapiddocsFileCursorLocation;
    }): RapiddocsFileCursorLocation {
    ...
    private getNewCursorLocation({
        ...
        previousLocation: RapiddocsFileCursorLocation | undefined;
        line: string;
    }): RapiddocsFileCursorLocation | undefined {
