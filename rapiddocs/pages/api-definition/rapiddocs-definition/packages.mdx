---
title: Packages in Rapiddocs Definition 
description: Rapiddocs Definition enables the reuse of API type and error names across packages, and can configure the structure of your API documentation.
---
...
other definition file, it can contain [imports](/learn/api-definition/rapiddocs/imports),
[types](/learn/api-definition/rapiddocs/types), [endpoints](/learn/api-definition/rapiddocs/endpoints),
and [errors](/learn/api-definition/rapiddocs/errors).
...
For example, let's say you have the following `rapiddocs/` folder:
