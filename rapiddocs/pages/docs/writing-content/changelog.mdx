...
[View an example](https://github.com/humanloop/humanloop-docs/blob/30ddedaf6d2779361e8ee1f373f722364e5dd71d/rapiddocs/versions/v5.yml#L10-L13) in GitHub of Humanloop's `docs.yml` which powers [their Changelog](https://humanloop.com/docs/changelog).
...
<CodeBlock title = "rapiddocs/openapi/changelog/2024-07-31.mdx">
```mdx
## Summary
