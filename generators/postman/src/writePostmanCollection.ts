...
import { RapiddocsPostmanClient } from "@rapiddocs-rapiddocs/postman-sdk";
import * as PostmanParsing from "@rapiddocs-rapiddocs/postman-sdk/serialization";
...
async function publishCollection({
    ...
    const postman = new RapiddocsPostmanClient({
