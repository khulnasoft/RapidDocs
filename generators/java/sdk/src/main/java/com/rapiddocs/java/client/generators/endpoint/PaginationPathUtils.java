...
import com.rapiddocs.ir.model.http.BytesRequest;
import com.rapiddocs.ir.model.http.FileUploadRequest;
import com.rapiddocs.ir.model.http.HttpEndpoint;
import com.rapiddocs.ir.model.http.HttpRequestBody;
import com.rapiddocs.ir.model.http.HttpRequestBodyReference;
import com.rapiddocs.ir.model.http.InlinedRequestBody;
import com.rapiddocs.ir.model.http.InlinedRequestBodyProperty;
...
public class PaginationPathUtils {
    ...
    public static List<EnrichedCursorPathSetter> getPathSetters(
        ...
        Optional<com.rapiddocs.ir.model.types.TypeReference> curr =
        ...
        for (int i = 0; i < enrichedItems.size(); i++) {
            ...
            com.rapiddocs.ir.model.types.TypeReference typeReference = referencesByName.get(
