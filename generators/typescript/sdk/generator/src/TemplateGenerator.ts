import { GetReferenceOpts, NpmPackage, PackageId, getTextOfTsNode } from "@rapiddocs-typescript/commons";
import { GeneratedEnumType, SdkContext } from "@rapiddocs-typescript/contexts";
import { OAuthTokenProviderGenerator } from "@rapiddocs-typescript/sdk-client-class-generator/src/oauth-generator/OAuthTokenProviderGenerator";
...
import { FdrSnippetTemplate } from "@rapiddocs-rapiddocs/snippet-sdk";
import { TemplateInput } from "@rapiddocs-rapiddocs/snippet-sdk/api";
import * as FDRAPIV1Read from "@rapiddocs-rapiddocs/snippet-sdk/api/resources/api/resources/v1/resources/read";

// Write this in the rapiddocs def to share between FE + BE
const TEMPLATE_SENTINEL = "$RAPIDDOCS_INPUT";
