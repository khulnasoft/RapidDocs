...
description: Rapiddocs SDKs include idiomatic support for discriminated unions
---

The SDKs natively support [discriminated unions](/learn/api-definition/rapiddocs/types#discriminated-unions) for both OpenAPI and Rapiddocs APIs.
...
<CodeBlock title="rapiddocs/definition/shape.yml">
  ```yaml
  types:
    Shape:
    union:
