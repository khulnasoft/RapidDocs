...
func (r *RequestOptions) cloneHeader() http.Header {
	...
	headers.Set("X-Rapiddocs-SDK-Name", "github.com/oauth-client-credentials-nested-root/rapiddocs")
	headers.Set("X-Rapiddocs-SDK-Version", "0.0.1")
	headers.Set("User-Agent", "github.com/oauth-client-credentials-nested-root/rapiddocs/0.0.1")
	return headers
}
