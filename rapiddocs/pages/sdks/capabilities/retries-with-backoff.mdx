...
Rapiddocs SDKs will automatically retry failed requests with exponential backoff. A request will be retried as
...
<CodeBlocks>
  ...
  <CodeBlock title="Go">
    ```go {7}
      import (
        imdbclient "github.com/rapiddocs-workos/workos-go/client"
        "github.com/rapiddocs-workos/workos-go/option"
      )
