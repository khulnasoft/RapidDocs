...
If you subscribe to Rapiddocs's Pro or Enterprise Plans, you can customize your API Explorer settings to suit your customers needs.
...
More information on enabling OAuth 2.0 Authorization Injection can be found [here](/learn/api-definition/rapiddocs/authentication#oauth-client-credentials).
