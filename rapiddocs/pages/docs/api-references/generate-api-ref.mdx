...
description: Use Rapiddocs Docs to generate your API Reference documentation from your API definition, using your choice of either OpenAPI or Rapiddocs Definition.
---

A key benefit of using Rapiddocs Docs is that once you've defined your API, you get your API Reference documentation with just one line.
Add `- api: API Reference` to your navigation in `docs.yml` and Rapiddocs takes care of the rest! You'll see your endpoints, types,
and cURL snippets automatically populated from your [OpenAPI Specification](/learn/api-definition/openapi/overview) or [Rapiddocs Definition](/learn/api-definition/rapiddocs/overview).
...
| `audiences`      | List of [audiences](/learn/api-definition/rapiddocs/audiences) to filter the API Reference for               |
