...
[![pypi](https://img.shields.io/pypi/v/rapiddocs_extra-properties)](https://pypi.python.org/pypi/rapiddocs_extra-properties)
...
```sh
pip install rapiddocs_extra-properties
```
