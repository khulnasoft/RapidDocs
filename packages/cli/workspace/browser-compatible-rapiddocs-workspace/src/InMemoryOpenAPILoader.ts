...
import { isOpenAPIV2, isOpenAPIV3_1 } from "@khulnasoft/api-workspace-commons";
import { mergeWithOverrides as coreMergeWithOverrides } from "@khulnasoft/core-utils";
import { OpenAPIDocument, getParseOptions } from "@khulnasoft/openapi-ir-parser";
