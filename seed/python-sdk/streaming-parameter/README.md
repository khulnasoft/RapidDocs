...
[![pypi](https://img.shields.io/pypi/v/rapiddocs_streaming-parameter)](https://pypi.python.org/pypi/rapiddocs_streaming-parameter)
...
```sh
pip install rapiddocs_streaming-parameter
```
