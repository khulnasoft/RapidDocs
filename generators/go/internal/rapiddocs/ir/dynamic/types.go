...
import (
	json "encoding/json"
	fmt "fmt"
	sdk "github.com/khulnasoft/rapiddocs-go/internal/rapiddocs/ir"
...
type Declaration struct {
	RapiddocsFilepath *sdk.RapiddocsFilepath `json:"rapiddocsFilepath,omitempty" url:"rapiddocsFilepath,omitempty"`
	Name         *sdk.Name         `json:"name,omitempty" url:"name,omitempty"`

	extraProperties map[string]interface{}
}

func (d *Declaration) GetRapiddocsFilepath() *sdk.RapiddocsFilepath {
	if d == nil {
		return nil
	}
