...
[![pypi](https://img.shields.io/pypi/v/rapiddocs_oauth-client-credentials-nested-root)](https://pypi.python.org/pypi/rapiddocs_oauth-client-credentials-nested-root)
...
```sh
pip install rapiddocs_oauth-client-credentials-nested-root
```
