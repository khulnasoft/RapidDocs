...
To make your TypeScript SDK publicly accessible, publish to [npm](https://www.npmjs.com/). Once you've followed the steps below to connect your npm account to your SDK, Rapiddocs will automatically publish the latest version of your SDK.  
...
<Steps>
### Open Repository
Open your Rapiddocs repository in GitHub.
