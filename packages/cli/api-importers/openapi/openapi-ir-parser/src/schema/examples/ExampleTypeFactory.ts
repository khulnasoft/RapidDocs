import { Examples, assertNever, isPlainObject, noop } from "@khulnasoft/core-utils";
import {
...
export class ExampleTypeFactory {
    ...
    ): RapiddocsOpenapiIr.ObjectSchemaWithExample | undefined {
    ...
    private getDiscriminatedUnionVariantSchema(
        schema: RapiddocsOpenapiIr.DiscriminatedOneOfSchemaWithExample,
    ...
    private getUnDiscriminatedUnionVariantSchema(
        schema: RapiddocsOpenapiIr.UnDiscriminatedOneOfSchemaWithExample,
        fullExample: unknown
