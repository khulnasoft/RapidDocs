...
import { MediaType, assertNever } from "@khulnasoft/core-utils";
import { RapiddocsOpenapiIr, ResponseWithExample, Source } from "@khulnasoft/openapi-ir";
...
export function convertResponse({
    ...
    let convertedResponse: RapiddocsOpenapiIr.ResponseWithExample | undefined = undefined;
...
function convertResolvedResponse({
            ...
            case "json":
                return ResponseWithExample.streamingJson({
                    ...
                    responseProperty: getExtension<string>(
                        ...
                        RapiddocsOpenAPIExtension.RESPONSE_PROPERTY
                    ),
    ...
    if (jsonMediaObject != null) {
        ...
        return ResponseWithExample.json({
            ...
            responseProperty: getExtension<string>(operationContext.operation, RapiddocsOpenAPIExtension.RESPONSE_PROPERTY),
            fullExamples: jsonMediaObject.examples,
            source,
            statusCode
        });
...
function markErrorSchemas({
    ...
    source: Source;
    namespace: string | undefined;
}): Record<RapiddocsOpenapiIr.StatusCode, RapiddocsOpenapiIr.HttpErrorWithExample> {
    const errors: Record<RapiddocsOpenapiIr.StatusCode, RapiddocsOpenapiIr.HttpErrorWithExample> = {};
