...
from rapiddocs.generator_exec import GeneratorConfig
...
from rapiddocs_python.generators.pydantic_model import (
    PydanticModelCustomConfig,
    PydanticModelGenerator,
)
from rapiddocs_python.snippet import SnippetRegistry
...
from .rapiddocs_http_exception import RapiddocsHTTPExceptionGenerator
...
class FastApiGenerator(AbstractGenerator):
    ...
    def run(
        ...
        *,
        ...
        RapiddocsHTTPExceptionGenerator(context=context, custom_config=custom_config).generate(
            project=project,
            generator_exec_wrapper=generator_exec_wrapper,
        )
