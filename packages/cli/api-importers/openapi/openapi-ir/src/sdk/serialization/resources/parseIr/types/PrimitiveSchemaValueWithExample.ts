...
export const PrimitiveSchemaValueWithExample: core.serialization.Schema<
    ...
    RapiddocsOpenapiIr.PrimitiveSchemaValueWithExample
> = core.serialization
    .union("type", {
        int: IntWithExample,
    ...
    .transform<RapiddocsOpenapiIr.PrimitiveSchemaValueWithExample>({
        transform: (value) => {
            switch (value.type) {
                case "int":
                    return RapiddocsOpenapiIr.PrimitiveSchemaValueWithExample.int(value);
                case "int64":
                    return RapiddocsOpenapiIr.PrimitiveSchemaValueWithExample.int64(value);
                case "uint":
                    return RapiddocsOpenapiIr.PrimitiveSchemaValueWithExample.uint(value);
                case "uint64":
                    return RapiddocsOpenapiIr.PrimitiveSchemaValueWithExample.uint64(value);
                case "float":
                    return RapiddocsOpenapiIr.PrimitiveSchemaValueWithExample.float(value);
                case "double":
                    return RapiddocsOpenapiIr.PrimitiveSchemaValueWithExample.double(value);
                case "string":
                    return RapiddocsOpenapiIr.PrimitiveSchemaValueWithExample.string(value);
                case "datetime":
                    return RapiddocsOpenapiIr.PrimitiveSchemaValueWithExample.datetime(value);
                case "date":
                    return RapiddocsOpenapiIr.PrimitiveSchemaValueWithExample.date(value);
                case "base64":
                    return RapiddocsOpenapiIr.PrimitiveSchemaValueWithExample.base64(value);
                case "boolean":
                    return RapiddocsOpenapiIr.PrimitiveSchemaValueWithExample.boolean(value);
                default:
                    return value as RapiddocsOpenapiIr.PrimitiveSchemaValueWithExample;
            }
        },
