export const RAPIDDOCS_DIRECTORY = "rapiddocs";
...
export const RAPIDDOCS_PACKAGE_MARKER_FILENAME_NO_EXTENSION = "__package__";
export const RAPIDDOCS_PACKAGE_MARKER_FILENAME = `${RAPIDDOCS_PACKAGE_MARKER_FILENAME_NO_EXTENSION}.yml`;
...
export const PROJECT_CONFIG_FILENAME = "rapiddocs.config.json";
export const DEFAULT_API_WORKSPACE_FOLDER_NAME = "api";
export const RAPIDDOCSIGNORE_FILENAME = ".rapiddocsignore";
