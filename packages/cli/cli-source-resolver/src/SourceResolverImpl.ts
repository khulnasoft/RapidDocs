...
import { AbsoluteFilePath, RelativeFilePath, doesPathExistSync, join } from "@khulnasoft/fs-utils";
import { ResolvedSource, SourceResolver } from "@khulnasoft/source-resolver";
...
export class SourceResolverImpl implements SourceResolver {
    ...
    private readonly workspace: RapiddocsWorkspace;
    private readonly sourceCache: Map<AbsoluteFilePath, ResolvedSource>;

    constructor(context: TaskContext, workspace: RapiddocsWorkspace) {
