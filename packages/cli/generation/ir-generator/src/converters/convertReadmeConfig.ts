...
import { HttpEndpoint, HttpService, ReadmeConfig, ServiceId } from "@khulnasoft/ir-sdk";
...
//
// Note that this is different than the EndpointResolver, which is used to resolve endpoints within a Rapiddocs
