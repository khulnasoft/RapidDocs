...
[![pypi](https://img.shields.io/pypi/v/rapiddocs_auth-environment-variables)](https://pypi.python.org/pypi/rapiddocs_auth-environment-variables)
...
```sh
pip install rapiddocs_auth-environment-variables
```
