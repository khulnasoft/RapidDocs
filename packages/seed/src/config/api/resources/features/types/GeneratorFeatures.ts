...
/**
 * Based on the features outlined within https://www.notion.so/buildwithrapiddocs/Generator-Features-2cc7e6c87fc54738843940d35af5c6a4?pvs=4
 */
export interface GeneratorFeatures {
     ...
     */
    requestOptions: RapiddocsSeedConfig.FeatureImplementation;
    /**
     ...
     */
    idempotency: RapiddocsSeedConfig.FeatureImplementation;
    /** SDK clients return an iterator that handles the pagination for the consumer. */
    autoPagination: RapiddocsSeedConfig.FeatureImplementation;
    /** The SDK should wrap the OAuth2 flow, and provide a way to automatically retrieve, refresh, and use the token. */
    oauth: RapiddocsSeedConfig.FeatureImplementation;
    /**
     * The SDK should allow for the defaulting of authentication headers from environment variables. Each authentication scheme
     * has a corresponding envvar property within it's Rapiddocs definition (`tokenEnvVar` in the BearerAuthScheme definition, for example).
     */
    authEnvVarScanning: RapiddocsSeedConfig.FeatureImplementation;
    /**
     ...
     */
    websocket: RapiddocsSeedConfig.FeatureImplementation;
    /**
     * Primarily used for chat completion.
     * Support streaming json responses, and provide a way to consume them. This
     */
    streamingJson: RapiddocsSeedConfig.FeatureImplementation;
    /** Support uploading files via multipart/form-data. */
    fileUpload: RapiddocsSeedConfig.FeatureImplementation;
    /** Support downloading files. */
    fileDownload: RapiddocsSeedConfig.FeatureImplementation;
    /** Generated code snippets for each endpoint are written to a snippets.json file. */
    snippets: RapiddocsSeedConfig.FeatureImplementation;
    /** Generated tests leveraging snippets, that can be run/tested via `rapiddocs test`. */
    snippetTests: RapiddocsSeedConfig.FeatureImplementation;
    /**
     ...
     */
    errors: RapiddocsSeedConfig.FeatureImplementation;
    /**
     ...
     */
    forwardCompatibleEnums: RapiddocsSeedConfig.FeatureImplementation;
    /**
     ...
     */
    additionalProperties: RapiddocsSeedConfig.FeatureImplementation;
    /**
     ...
     */
    apiReferenceGeneration: RapiddocsSeedConfig.FeatureImplementation;
    /**
     * Whether the generator supports reading the whitelabel configuration.
     * If true, the generator will not mention `rapiddocs` in the header of the
     * generated code.
     *
     * Instead of `This file was auto-generated by Rapiddocs from our API Definition`,
     * the header will read `This file was auto-generated from our API Definition`.
     */
    whitelabel: RapiddocsSeedConfig.FeatureImplementation;
    /**
     ...
     */
    polling: RapiddocsSeedConfig.FeatureImplementation;
}
