import { CSharpFile, EXTERNAL_PROTO_STRUCT_CLASS_REFERENCE, FileGenerator, csharp } from "@khulnasoft/csharp-codegen";
import { RelativeFilePath, join } from "@khulnasoft/fs-utils";

import { TypeDeclaration } from "@rapiddocs-rapiddocs/ir-sdk/api";
