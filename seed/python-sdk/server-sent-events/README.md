...
[![pypi](https://img.shields.io/pypi/v/rapiddocs_server-sent-events)](https://pypi.python.org/pypi/rapiddocs_server-sent-events)
...
```sh
pip install rapiddocs_server-sent-events
```
