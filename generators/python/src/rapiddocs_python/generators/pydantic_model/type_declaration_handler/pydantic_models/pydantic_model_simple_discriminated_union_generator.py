...
from rapiddocs_python.generators.pydantic_model.rapiddocs_aware_pydantic_model import (
    RapiddocsAwarePydanticModel,
)
from rapiddocs_python.generators.pydantic_model.type_declaration_handler.discriminated_union.simple_discriminated_union_generator import (
...
class PydanticModelSimpleDiscriminatedUnionGenerator(AbstractSimpleDiscriminatedUnionGenerator):
    ...
    def _generate_base_class(self) -> None:
        if self._should_generate_base_class:
            with RapiddocsAwarePydanticModel(
    ...
    def _generate_single_property_member(
        ...
        # TODO: turn this into a RapiddocsAwarePydanticModel to be able to handle circular references
    ...
    # Really needed since we're not using a RapiddocsAwarePydanticModel for single property members
    #
