import { isPlainObject } from "@khulnasoft/core-utils";
import { EXAMPLE_REFERENCE_PREFIX } from "@khulnasoft/rapiddocs-definition-schema";
...
export interface ExampleResolver {
    ...
    resolveAllReferencesInExampleOrThrow: (args: { example: unknown; file: RapiddocsFileContext }) => {
        resolvedExample: unknown;
    };
    resolveExample: (args: {
        example: unknown;
        file: RapiddocsFileContext;
    }) => { resolvedExample: unknown; file: RapiddocsFileContext } | undefined;
    resolveExampleOrThrow: (args: { example: unknown; file: RapiddocsFileContext }) => {
        resolvedExample: unknown;
        file: RapiddocsFileContext;
    };
...
export class ExampleResolverImpl implements ExampleResolver {
    ...
    public resolveAllReferencesInExampleOrThrow({ example, file }: { example: unknown; file: RapiddocsFileContext }): {
        resolvedExample: unknown;
    } {
    ...
    public resolveExampleOrThrow({ example, file }: { example: unknown; file: RapiddocsFileContext }): {
        resolvedExample: unknown;
        file: RapiddocsFileContext;
    } {
