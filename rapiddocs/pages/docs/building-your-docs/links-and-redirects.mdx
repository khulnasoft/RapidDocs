...
description: Set up the navigation for your documentation site built with Rapiddocs Docs using the docs.yml file
---
## Redirects
...
<Note title="Subpaths">
If your docs are hosted on a subpath (like `buildwithrapiddocs.com/learn`), be sure to include the subpath in the redirect. 
</Note>
