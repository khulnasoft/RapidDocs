---
title: Examples in Rapiddocs Definition 
subtitle: Use Rapiddocs Definition to add API examples that are shown in comments of SDKs, API Reference documentation, and a Postman collection.
---
...
The Rapiddocs CLI validates that your examples match the expected types. The following won't compile:
