...
func (r *RequestOptions) ToHeader() http.Header {
	...
	if r.ApiKey != "" {
		header.Set("X-RAPIDDOCS-API-KEY", fmt.Sprintf("%v", r.ApiKey))
	}
...
func (r *RequestOptions) cloneHeader() http.Header {
	...
	headers.Set("X-Rapiddocs-Language", "Go")
	headers.Set("X-Rapiddocs-SDK-Name", "github.com/auth-environment-variables/rapiddocs")
	headers.Set("X-Rapiddocs-SDK-Version", "0.0.1")
	headers.Set("User-Agent", "github.com/auth-environment-variables/rapiddocs/0.0.1")
	return headers
}
