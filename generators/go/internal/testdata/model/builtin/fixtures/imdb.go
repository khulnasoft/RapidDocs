...
import (
	json "encoding/json"
	fmt "fmt"
	internal "github.com/khulnasoft/rapiddocs-go/internal/testdata/model/builtin/fixtures/internal"
...
func (t *Type) UnmarshalJSON(data []byte) error {
	...
	*t = Type(unmarshaler.embed)
	...
	if unmarshaler.Eighteen != "rapiddocs" {
		return fmt.Errorf("unexpected value for literal on type %T; expected %v got %v", t, "rapiddocs", unmarshaler.Eighteen)
	}
