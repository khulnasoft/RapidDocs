...
If you use Rapiddocs Docs, this feature is auto-enabled like /robots.txt and /sitemap.xml. [Learn more](https://buildwithrapiddocs.com/learn/docs/developer-tools/llms-txt)

![LLMs.txt Splash Image](../../../../rapiddocs/assets/changelogs/docs/llms-txt.png)
