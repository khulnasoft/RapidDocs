import { Arguments, DiscriminatedUnionTypeInstance, Severity } from "@khulnasoft/browser-compatible-base-generator";
...
export class DynamicTypeLiteralMapper {
    ...
    private convertLiteral({
        ...
        literalType: RapiddocsIr.dynamic.LiteralType;
        value: unknown;
    }): php.TypeLiteral {
    ...
    private convertList({ list, value }: { list: RapiddocsIr.dynamic.TypeReference; value: unknown }): php.TypeLiteral {
    ...
    private convertMap({ map, value }: { map: RapiddocsIr.dynamic.MapType; value: unknown }): php.TypeLiteral {
                ...
                writer.writeNode(
                    php.invokeMethod({
                        on: php.classReference({
                            ...
                            namespace: this.context.getTypesNamespace(discriminatedUnion.declaration.rapiddocsFilepath)
                        }),
    ...
    private convertDiscriminatedUnionProperties({
        ...
        unionVariant: RapiddocsIr.dynamic.SingleDiscriminatedUnionType;
            ...
            return [
                ...
                php.TypeLiteral.class_({
                    reference: php.classReference({
                        ...
                        namespace: this.context.getTypesNamespace(named.declaration.rapiddocsFilepath)
                    }),
    ...
    private convertObject({ object_, value }: { object_: RapiddocsIr.dynamic.ObjectType; value: unknown }): php.TypeLiteral {
        const properties = this.context.associateByWireValue({
        ...
        return php.TypeLiteral.class_({
            reference: php.classReference({
                ...
                namespace: this.context.getTypesNamespace(object_.declaration.rapiddocsFilepath)
            }),
    ...
    private convertEnum({ enum_, value }: { enum_: RapiddocsIr.dynamic.EnumType; value: unknown }): php.TypeLiteral {
            ...
            php.codeblock((writer) => {
                writer.writeNode(
                    php.classReference({
                        ...
                        namespace: this.context.getTypesNamespace(enum_.declaration.rapiddocsFilepath)
                    })
                );
                writer.write("::");
                writer.write(name);
