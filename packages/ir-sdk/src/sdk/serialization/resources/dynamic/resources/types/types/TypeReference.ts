...
export const TypeReference: core.serialization.Schema<
    ...
    RapiddocsIr.dynamic.TypeReference
> = core.serialization
    .union("type", {
    ...
    .transform<RapiddocsIr.dynamic.TypeReference>({
        transform: (value) => {
            switch (value.type) {
                case "list":
                    return RapiddocsIr.dynamic.TypeReference.list(value.value);
                case "literal":
                    return RapiddocsIr.dynamic.TypeReference.literal(value.value);
                case "map":
                    return RapiddocsIr.dynamic.TypeReference.map(value);
                case "named":
                    return RapiddocsIr.dynamic.TypeReference.named(value.value);
                case "nullable":
                    return RapiddocsIr.dynamic.TypeReference.nullable(value.value);
                case "optional":
                    return RapiddocsIr.dynamic.TypeReference.optional(value.value);
                case "primitive":
                    return RapiddocsIr.dynamic.TypeReference.primitive(value.value);
                case "set":
                    return RapiddocsIr.dynamic.TypeReference.set(value.value);
                case "unknown":
                    return RapiddocsIr.dynamic.TypeReference.unknown();
                default:
                    return value as RapiddocsIr.dynamic.TypeReference;
            }
        },
