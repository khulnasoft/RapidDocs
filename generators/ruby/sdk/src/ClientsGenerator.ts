import { AbstractGeneratorContext } from "@khulnasoft/base-generator";
import {
...
export class ClientsGenerator {
    ...
    constructor({
        ...
        this.subpackages.forEach((subpackage, subpackageId) => {
            const path = subpackage.rapiddocsFilepath.allParts.map((part) => getSubpackagePropertyNameFromIr(part));
    ...
    public generateFiles(): GeneratedFile[] {
        ...
        function getServiceClasses(
            ...
            const serviceModule = Module_.wrapInModules({
                ...
                path: subpackage.rapiddocsFilepath,
                includeFilename: false
            });
            const serviceFile = new GeneratedRubyFile({
                rootNode: serviceModule,
                fullPath: locationGenerator.getLocationFromRapiddocsFilepath(subpackage.rapiddocsFilepath, "client")
            });
