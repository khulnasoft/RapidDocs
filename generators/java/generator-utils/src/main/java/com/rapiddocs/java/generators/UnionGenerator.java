...
import com.rapiddocs.ir.model.constants.Constants;
import com.rapiddocs.ir.model.types.*;
import com.rapiddocs.java.AbstractGeneratorContext;
import com.rapiddocs.java.RapiddocsJavaAnnotations;
import com.rapiddocs.java.PoetTypeNameMapper;
import com.rapiddocs.java.generators.union.UnionSubType;
import com.rapiddocs.java.generators.union.UnionTypeSpecGenerator;
            ...
            singleUnionType.getShape().visit(new SingleUnionTypeProperties.Visitor<Void>() {
                ...
                public Void visitSamePropertiesAsObject(DeclaredTypeName samePropertiesAsObject) {
                    constructors.add(MethodSpec.constructorBuilder()
                            .addModifiers(Modifier.PRIVATE)
                            .addAnnotation(RapiddocsJavaAnnotations.jacksonPropertiesCreator())
                            .build());
                    constructors.add(MethodSpec.constructorBuilder()
                            .addModifiers(Modifier.PRIVATE)
                            .addParameter(ParameterSpec.builder(
                                            poetTypeNameMapper.convertToTypeName(
                                                    ...
                                                    TypeReference.named(NamedType.builder()
                                                            ...
                                                            .rapiddocsFilepath(samePropertiesAsObject.getRapiddocsFilepath())
