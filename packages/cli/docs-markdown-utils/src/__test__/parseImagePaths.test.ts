...
import { AbsoluteFilePath, relative } from "@khulnasoft/fs-utils";
...
const MDX_PATH = AbsoluteFilePath.of("/Volume/git/rapiddocs/my/docs/folder/file.mdx");
const DOCS_PATH = AbsoluteFilePath.of("/Volume/git/rapiddocs");

const PATHS = {
    absolutePathToMarkdownFile: MDX_PATH,
    absolutePathToRapiddocsFolder: DOCS_PATH
};
...
describe("parseImagePaths", () => {
    ...
    it("should return an array of image paths", () => {
        ...
        const result = parseImagePaths(page, PATHS);
        expect(result.filepaths).toEqual(["/Volume/git/rapiddocs/my/docs/folder/path/to/image.png"]);
        expect(result.markdown.trim()).toMatchInlineSnapshot(
            '"This is a test page with an image ![image](/Volume/git/rapiddocs/my/docs/folder/path/to/image.png)"'
        );
    });
    ...
    it("should return an array of image paths with multiple images", () => {
        ...
        const result = parseImagePaths(page, PATHS);
        expect(result.filepaths).toEqual([
            "/Volume/git/rapiddocs/my/docs/folder/path/to/image1.png",
            "/Volume/git/rapiddocs/my/docs/folder/path/to/image2.png"
        ]);
        expect(result.markdown.trim()).toMatchInlineSnapshot(
            '"This is a test page with an image ![image1](/Volume/git/rapiddocs/my/docs/folder/path/to/image1.png) and another image ![image2](/Volume/git/rapiddocs/my/docs/folder/path/to/image2.png)"'
        );
    });
    ...
    it("should return an array of image paths with multiple images of the same path", () => {
        ...
        expect(result.filepaths).toEqual(["/Volume/git/rapiddocs/my/docs/folder/path/to/image.png"]);
        expect(result.markdown.trim()).toMatchInlineSnapshot(
            '"This is a test page with an image ![image1](/Volume/git/rapiddocs/my/docs/folder/path/to/image.png) and another image ![image2](/Volume/git/rapiddocs/my/docs/folder/path/to/image.png)"'
        );
    });
    ...
    it("should return an array of image paths from html image tags", () => {
        ...
        expect(result.filepaths).toEqual(["/Volume/git/rapiddocs/my/docs/folder/path/to/image.png"]);
        expect(result.markdown.trim()).toMatchInlineSnapshot(
            "\"This is a test page with an image <img src='/Volume/git/rapiddocs/my/docs/folder/path/to/image.png' />\""
        );
    });
    ...
    it("should return an array of image paths from html image tags with multiple images", () => {
        ...
        expect(result.markdown.trim()).toMatchInlineSnapshot(
            "\"This is a test page with an image <img src='/Volume/git/rapiddocs/my/docs/folder/path/to/image1.png' /> and another image <img src='/Volume/git/rapiddocs/my/docs/folder/path/to/image2.png' />\""
        );
    });
    ...
    it("should return an array of image paths from both markdown and html image tags", () => {
        ...
        expect(result.markdown.trim()).toMatchInlineSnapshot(`
            "This is a test page with an image ![image1](/Volume/git/rapiddocs/my/docs/folder/path/to/image1.png) and another image 
            <img src='/Volume/git/rapiddocs/my/docs/folder/path/to/image2.png' />"
        `);
    });
    ...
    it("should parse images from frontmatter text", () => {
        ...
        expect(result.filepaths).toEqual(["/Volume/git/rapiddocs/my/docs/folder/path/to/image.png"]);
        expect(result.markdown.trim()).toEqual(
            "---\nimage:\n  type: fileId\n  value: /Volume/git/rapiddocs/my/docs/folder/path/to/image.png\n---"
        );
    });
    ...
    it("should parse light and dark logo from frontmatter json", () => {
        ...
        const result = parseImagePaths(page, PATHS);
        expect(result.filepaths).toEqual([
            "/Volume/git/rapiddocs/my/docs/folder/path/to/light-image.png",
            "/Volume/git/rapiddocs/my/docs/folder/path/to/dark-image.png"
        ]);
        expect(result.markdown.trim()).toMatchInlineSnapshot(
            `
          "---
          logo:
            light:
              type: fileId
              value: /Volume/git/rapiddocs/my/docs/folder/path/to/light-image.png
            dark:
              type: fileId
              value: /Volume/git/rapiddocs/my/docs/folder/path/to/dark-image.png
          ---"
        `
        );
    });
    ...
    it("should parse light logo from frontmatter json", () => {
        const page = '---\nlogo:\n  light: "path/to/light-image.png"\n---';
        const result = parseImagePaths(page, PATHS);
        expect(result.filepaths).toEqual(["/Volume/git/rapiddocs/my/docs/folder/path/to/light-image.png"]);
        expect(result.markdown.trim()).toMatchInlineSnapshot(
            `
          "---
          logo:
    ...
    it("should parse dark logo from frontmatter json", () => {
        const page = '---\nlogo:\n  dark: "path/to/dark-image.png"\n---';
        const result = parseImagePaths(page, PATHS);
        expect(result.filepaths).toEqual(["/Volume/git/rapiddocs/my/docs/folder/path/to/dark-image.png"]);
        expect(result.markdown.trim()).toMatchInlineSnapshot(
            `
          "---
          logo:
    ...
    it("should parse image with alt on multiple lines", () => {
        ...
        expect(result.markdown.trim()).toMatchInlineSnapshot(`
            "This is a test page with an image ![image with 
             new line in alt](/Volume/git/rapiddocs/my/docs/folder/path/to/image.png)"
        `);
    });
    ...
    it("should parse img tag with src on multiple lines", () => {
        ...
        expect(result.markdown.trim()).toMatchInlineSnapshot(`
            "This is a test page with an image <img 
             src='/Volume/git/rapiddocs/my/docs/folder/path/to/image.png' 
             alt='image' />"
        `);
    });
    ...
    it("should relativize absolute paths", () => {
        const page = "This is a test page with an image ![image](/path/to/image.png)";
        const result = parseImagePaths(page, PATHS);
        expect(result.filepaths).toEqual(["/Volume/git/rapiddocs/path/to/image.png"]);
        expect(result.markdown.trim()).toMatchInlineSnapshot(
            '"This is a test page with an image ![image](/Volume/git/rapiddocs/path/to/image.png)"'
        );
    });
    ...
    it("should relativize absolute paths in html image tags", () => {
        ...
        expect(result.filepaths).toEqual(["/Volume/git/rapiddocs/path/to/image.png"]);
        expect(result.markdown.trim()).toMatchInlineSnapshot(
            "\"This is a test page with an image <img src='/Volume/git/rapiddocs/path/to/image.png' />\""
        );
    });
    ...
    it("should relativize absolute paths in html image tags with multiple images", () => {
        ...
        const result = parseImagePaths(page, PATHS);
        expect(result.filepaths).toEqual([
            "/Volume/git/rapiddocs/path/to/image1.png",
            "/Volume/git/rapiddocs/path/to/image2.png"
        ]);
        expect(result.markdown.trim()).toMatchInlineSnapshot(
            "\"This is a test page with an image <img src='/Volume/git/rapiddocs/path/to/image1.png' /> and another image <img src='/Volume/git/rapiddocs/path/to/image2.png' />\""
        );
    });
    ...
    it("should relative absolute paths in mdx img tags with other props before src", () => {
        ...
        expect(result.filepaths).toEqual(["/Volume/git/rapiddocs/path/to/image.png"]);
        expect(result.markdown.trim()).toMatchInlineSnapshot(
            "\"This is a test page with an image <img alt='image' src={'/Volume/git/rapiddocs/path/to/image.png'} />\""
        );
    });
    ...
    it("should relative absolute paths in mdx img tags with other props after src", () => {
        ...
        expect(result.filepaths).toEqual(["/Volume/git/rapiddocs/path/to/image.png"]);
        expect(result.markdown.trim()).toMatchInlineSnapshot(
            "\"This is a test page with an image <img src={'/Volume/git/rapiddocs/path/to/image.png'} style={{border: '1px'}} />\""
        );
    });
    ...
    it("should return an array of image paths inside CodeBlock", () => {
        ...
        expect(result.filepaths).toEqual(["/Volume/git/rapiddocs/my/docs/folder/path/to/image.png"]);
        expect(result.markdown.trim()).toMatchInlineSnapshot(
            "\"This is a test page with an image <CodeBlock>{<img src='/Volume/git/rapiddocs/my/docs/folder/path/to/image.png' />}</CodeBlock>\""
        );
    });
    ...
    it("should ignore non-html tags, but still parse img tags", () => {
        ...
        expect(result.filepaths).toEqual(["/Volume/git/rapiddocs/my/docs/folder/path/to/image.png"]);
        expect(result.markdown.trim()).toMatchInlineSnapshot(
            "\"This is a test page with an image <Section> <img src='/Volume/git/rapiddocs/my/docs/folder/path/to/image.png' /> </Section>\""
        );
    });
    ...
    it("should accept mdx img tags within a JSX prop", () => {
        ...
        expect(result.filepaths).toEqual(["/Volume/git/rapiddocs/my/docs/folder/path/to/image.png"]);
        expect(result.markdown.trim()).toMatchInlineSnapshot(
            "\"This is a test page with an image <Node image={<img src='/Volume/git/rapiddocs/my/docs/folder/path/to/image.png' />} />\""
        );
    });
    ...
    it("should ignore anchors when replacing image paths", () => {
        ...
        expect(result.filepaths).toEqual(["/Volume/git/rapiddocs/my/docs/folder/path/to/image.png"]);
        expect(result.markdown.trim()).toMatchInlineSnapshot(
            '"This is a test page with an image ![image](/Volume/git/rapiddocs/my/docs/folder/path/to/image.png#anchor)"'
        );
    });
    ...
    it("should ignore anchors in html image tags", () => {
        ...
        expect(result.filepaths).toEqual(["/Volume/git/rapiddocs/my/docs/folder/path/to/image.png"]);
        expect(result.markdown.trim()).toMatchInlineSnapshot(
            "\"This is a test page with an image <img src='/Volume/git/rapiddocs/my/docs/folder/path/to/image.png#anchor' />\""
        );
    });
...
<Tabs>
    <Tab>
        ...
        `;
        const result = parseImagePaths(page, PATHS);
        expect(result.filepaths).toEqual(["/Volume/git/rapiddocs/my/docs/folder/add-tool-view.png"]);
        expect(result.markdown.trim()).toMatchInlineSnapshot(`
            "<Tabs>
                <Tab>
                    <Frame>
                        <img src="/Volume/git/rapiddocs/my/docs/folder/add-tool-view.png" alt="Add tool to configuration within the portal"/>
                    </Frame>
                </Tab>
            </Tabs>"
        `);
    ...
    <Tab>
        ...
        expect(result.markdown.trim()).toMatchInlineSnapshot(`
            "<Tabs>
                <Tab>
                    <Frame>
                        ![Add tool to configuration within the portal](/Volume/git/rapiddocs/my/docs/folder/add-tool-view.png)
                    </Frame>
                </Tab>
            </Tabs>"
        `);
...
<Download src="path/to/file.zip">
    Download file
        ...
        `;
        const result = parseImagePaths(page, PATHS);
        expect(result.filepaths).toEqual(["/Volume/git/rapiddocs/my/docs/folder/path/to/file.zip"]);
    });
...
<video>
    <source src="path/to/file.mp4" />
        ...
        `;
        const result = parseImagePaths(page, PATHS);
        expect(result.filepaths).toEqual(["/Volume/git/rapiddocs/my/docs/folder/path/to/file.mp4"]);
    });

    describe("image path resolution", () => {
        const MOCK_FILE_IDS = {
            "/Volume/git/rapiddocs/absolute/path/image.png": "absolute-file-id",
            "/Volume/git/rapiddocs/my/docs/folder/relative/path/image.png": "relative-file-id",
            "/Volume/git/rapiddocs/my/docs/relative/path/image.png": "parent-relative-file-id",
            "/Volume/git/rapiddocs/my/docs/folder/current/image.png": "current-file-id",
            // Windows paths need to be normalized to forward slashes
            "/C/Users/git/rapiddocs/absolute/path/image.png": "windows-absolute-file-id",
            "//server/share/path/image.png": "windows-unc-file-id"
        };

        const TEST_PATHS = {
            absolutePathToMarkdownFile: AbsoluteFilePath.of("/Volume/git/rapiddocs/my/docs/folder/file.mdx"),
            absolutePathToRapiddocsFolder: AbsoluteFilePath.of("/Volume/git/rapiddocs"),
        ...
        it("should handle absolute paths", () => {
            ...
            expect(result.filepaths).toEqual(["/Volume/git/rapiddocs/absolute/path/image.png"]);
            expect(result.markdown.trim()).toMatchInlineSnapshot(
                '"This is a test page with an image ![image](/Volume/git/rapiddocs/absolute/path/image.png)"'
            );
        });
        ...
        it("should handle relative paths", () => {
            ...
            const result = parseImagePaths(page, TEST_PATHS);
            expect(result.filepaths).toEqual(["/Volume/git/rapiddocs/my/docs/folder/relative/path/image.png"]);
            expect(result.markdown.trim()).toMatchInlineSnapshot(
                '"This is a test page with an image ![image](/Volume/git/rapiddocs/my/docs/folder/relative/path/image.png)"'
            );
        });
        ...
        it("should handle parent directory relative paths", () => {
            const page = "This is a test page with an image ![image](../relative/path/image.png)";
            const result = parseImagePaths(page, TEST_PATHS);
            expect(result.filepaths).toEqual(["/Volume/git/rapiddocs/my/docs/relative/path/image.png"]);
            expect(result.markdown.trim()).toMatchInlineSnapshot(
                '"This is a test page with an image ![image](/Volume/git/rapiddocs/my/docs/relative/path/image.png)"'
            );
        });
        ...
        it("should handle current directory relative paths", () => {
            ...
            const result = parseImagePaths(page, TEST_PATHS);
            expect(result.filepaths).toEqual(["/Volume/git/rapiddocs/my/docs/folder/current/image.png"]);
            expect(result.markdown.trim()).toMatchInlineSnapshot(
                '"This is a test page with an image ![image](/Volume/git/rapiddocs/my/docs/folder/current/image.png)"'
            );
        });
        ...
        it("should return undefined for non-existent file IDs", () => {
            ...
            const result = parseImagePaths(page, TEST_PATHS);
            expect(result.filepaths).toEqual(["/Volume/git/rapiddocs/non/existent/path/image.png"]);
            expect(result.markdown.trim()).toMatchInlineSnapshot(
                '"This is a test page with an image ![image](/Volume/git/rapiddocs/non/existent/path/image.png)"'
            );
        });
        ...
        it("should handle multiple images with mixed paths", () => {
            ...
            const result = parseImagePaths(page, TEST_PATHS);
            expect(result.filepaths).toEqual([
                "/Volume/git/rapiddocs/absolute/path/image.png",
                "/Volume/git/rapiddocs/my/docs/folder/relative/path/image.png",
                "/Volume/git/rapiddocs/my/docs/relative/path/image.png",
                "/Volume/git/rapiddocs/my/docs/folder/current/image.png"
            ]);
            expect(result.markdown.trim()).toMatchInlineSnapshot(`
              "This is a test page with multiple images:
                              ![absolute](/Volume/git/rapiddocs/absolute/path/image.png)
                              ![relative](/Volume/git/rapiddocs/my/docs/folder/relative/path/image.png)
                              ![parent](/Volume/git/rapiddocs/my/docs/relative/path/image.png)
                              ![current](/Volume/git/rapiddocs/my/docs/folder/current/image.png)"
            `);
        });
        ...
        describe("windows paths", () => {
            it("should handle Windows absolute paths with drive letter", () => {
                const page =
                    "This is a test page with an image ![image](C:\\Users\\git\\rapiddocs\\absolute\\path\\image.png)";
                const result = parseImagePaths(page, TEST_PATHS);
                expect(result.filepaths).toEqual([
                    "/Volume/git/rapiddocs/my/docs/folder/C:/Users/git/rapiddocs/absolute/path/image.png"
                ]);
                expect(result.markdown.trim()).toMatchInlineSnapshot(
                    '"This is a test page with an image ![image](/Volume/git/rapiddocs/my/docs/folder/C:/Users/git/rapiddocs/absolute/path/image.png)"'
                );
            });
...
describe("replaceImagePaths", () => {
    it("should replace image paths with fileIDs", () => {
        const page = "This is a test page with an image ![image](/Volume/git/rapiddocs/path/to/image.png)";
        const fileIds = new Map([[AbsoluteFilePath.of("/Volume/git/rapiddocs/path/to/image.png"), "fileID"]]);
    ...
    it("should ignore anchors when replacing image paths", () => {
        const page = "This is a test page with an image ![image](/Volume/git/rapiddocs/path/to/image.png#anchor)";
        const fileIds = new Map([[AbsoluteFilePath.of("/Volume/git/rapiddocs/path/to/image.png"), "fileID"]]);
        const result = replaceImagePathsAndUrls(page, fileIds, {}, PATHS, CONTEXT);
        expect(result).toMatchInlineSnapshot(`
    ...
    it("should ignore anchors when replacing image paths in img tag", () => {
        const page = "This is a test page with an image <img src='/Volume/git/rapiddocs/path/to/image.png#anchor' />";
        const fileIds = new Map([[AbsoluteFilePath.of("/Volume/git/rapiddocs/path/to/image.png"), "fileID"]]);
        const result = replaceImagePathsAndUrls(page, fileIds, {}, PATHS, CONTEXT);
        expect(result).toMatchInlineSnapshot(`
