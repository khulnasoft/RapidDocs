...
import { CasingsGenerator, constructCasingsGenerator } from "@khulnasoft/casings-generator";
...
export class DynamicSnippetsConverter {
    ...
    private convertEndpoint({
        ...
        return {
            auth: this.auth,
            declaration: this.convertDeclaration({ name: endpoint.name, rapiddocsFilepath: endpoint.rapiddocsFilepath }),
            location,
        ...
        switch (endpoint.sdkRequest.shape.type) {
            ...
            case "wrapper":
                return this.convertInlinedRequest({
                    rapiddocsFilepath: endpoint.rapiddocsFilepath,
    ...
    private convertInlinedRequest({
        ...
        return DynamicSnippets.Request.inlined({
            declaration: this.convertDeclaration({ name: wrapper.wrapperName, rapiddocsFilepath }),
            pathParameters,
            queryParameters,
            headers,
