import { assertNever, isNonNullish } from "@khulnasoft/core-utils";
...
export class ExampleEndpointFactory {
    ...
    public buildEndpointExample(endpoint: EndpointWithExample): EndpointExample[] {
        ...
        const requestExamples: [id: string | undefined, example: RapiddocsOpenapiIr.FullExample][] = [];
        ...
        const responseExamples: [id: string | undefined, example: RapiddocsOpenapiIr.EndpointResponseExample][] = [];
...
function consolidateRequestResponseExamples(
    requestExamples: [id: string | undefined, example: RapiddocsOpenapiIr.FullExample][],
    responseExamples: [id: string | undefined, example: RapiddocsOpenapiIr.EndpointResponseExample][]
): RequestResponsePair[] {
...
function convertMultipartRequestToSchema(request: RequestWithExample.Multipart): RapiddocsOpenapiIr.SchemaWithExample {
    return SchemaWithExample.object({
        properties: request.properties
            .map((property) => {
                if (property.schema.type === "file") {
                    // TODO: Handle file property examples in the Rapiddocs Definition
                    return null;
                }
                return {
                    key: property.key,
