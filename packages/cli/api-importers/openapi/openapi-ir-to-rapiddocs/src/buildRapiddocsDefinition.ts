...
import { isRawAliasDefinition } from "@khulnasoft/rapiddocs-definition-schema";
import { RapiddocsDefinition } from "@khulnasoft/importer-commons";
...
export const ERROR_DECLARATIONS_FILENAME = RelativeFilePath.of(RAPIDDOCS_PACKAGE_MARKER_FILENAME);
...
export function buildRapiddocsDefinition(context: OpenApiIrConverterContext): RapiddocsDefinition {
