...
<embed src="../../../../rapiddocs/assets/changelogs/docs/accordion.mp4" type="video/mp4" width="640px" height="360px" />
...
Read more [here](https://buildwithrapiddocs.com/learn/docs/content/write-markdown#embedding-local-assets)