...
[![pypi](https://img.shields.io/pypi/v/rapiddocs_oauth-client-credentials-default)](https://pypi.python.org/pypi/rapiddocs_oauth-client-credentials-default)
...
```sh
pip install rapiddocs_oauth-client-credentials-default
```
