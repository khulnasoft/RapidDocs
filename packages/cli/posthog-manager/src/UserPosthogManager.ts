...
import { RapiddocsUserToken, getUserIdFromToken } from "@khulnasoft/auth";
...
export class UserPosthogManager implements PosthogManager {
    ...
    constructor({ token, posthogApiKey }: { token: RapiddocsUserToken | undefined; posthogApiKey: string }) {
