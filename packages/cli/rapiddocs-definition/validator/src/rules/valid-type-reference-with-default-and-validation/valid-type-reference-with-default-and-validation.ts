import { RawSchemas, isRawEnumDefinition } from "@khulnasoft/rapiddocs-definition-schema";
import { ResolvedType, TypeResolverImpl, constructRapiddocsFileContext } from "@khulnasoft/ir-generator";
        ...
        return {
            definitionFile: {
                ...
                typeReference: (
                    ...
                    const file = constructRapiddocsFileContext({
                        relativeFilepath,
                        definitionFile,
