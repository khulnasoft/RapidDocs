...
import { OpenAPISettings } from "@khulnasoft/api-workspace-commons";
...
import { ContainerType, DeclaredTypeName, Package, TypeDeclaration, TypeId, TypeReference } from "@khulnasoft/ir-sdk";
