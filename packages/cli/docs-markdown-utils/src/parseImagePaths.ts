...
import { AbsoluteFilePath, RelativeFilePath, dirname, resolve } from "@khulnasoft/fs-utils";
...
function resolvePath(
    ...
    { absolutePathToRapiddocsFolder, absolutePathToMarkdownFile }: AbsolutePathMetadata
    ...
    const filepath = resolve(
        pathToImage.startsWith("/") ? absolutePathToRapiddocsFolder : dirname(absolutePathToMarkdownFile),
