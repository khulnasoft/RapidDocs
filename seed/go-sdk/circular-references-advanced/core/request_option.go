...
func (r *RequestOptions) cloneHeader() http.Header {
	...
	headers.Set("X-Rapiddocs-SDK-Name", "github.com/circular-references-advanced/rapiddocs")
	headers.Set("X-Rapiddocs-SDK-Version", "0.0.1")
	headers.Set("User-Agent", "github.com/circular-references-advanced/rapiddocs/0.0.1")
	return headers
}
