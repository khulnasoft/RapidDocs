...
import { ContainerType, TypeReference } from "@khulnasoft/ir-sdk";
...
export interface TypeResolver {
    resolveType: (args: { type: string; file: RapiddocsFileContext }) => ResolvedType | undefined;
    resolveTypeOrThrow: (args: { type: string; file: RapiddocsFileContext }) => ResolvedType;
    ...
    resolveNamedType: (args: { referenceToNamedType: string; file: RapiddocsFileContext }) => ResolvedType | undefined;
    resolveNamedTypeOrThrow: (args: { referenceToNamedType: string; file: RapiddocsFileContext }) => ResolvedType;
}
...
export class TypeResolverImpl implements TypeResolver {
    ...
    public resolveTypeOrThrow({ type, file }: { type: string; file: RapiddocsFileContext }): ResolvedType {
    ...
    private resolveNamedTypeFromDeclaration({
        ...
        referencedIn: RapiddocsFileContext;
        referenceToNamedType: string;
