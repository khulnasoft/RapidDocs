import { RapiddocsDefinition } from "@khulnasoft/api-workspace-commons";
import { keys } from "@khulnasoft/core-utils";
import { RelativeFilePath } from "@khulnasoft/fs-utils";
import { getResolvedPathOfImportedFile } from "@khulnasoft/ir-generator";
...
function findCircularImports(definitionFiles: RapiddocsDefinition["namedDefinitionFiles"]): CircularImports {
...
function findCircularImportsRecursive(
    ...
    definitionFiles: RapiddocsDefinition["namedDefinitionFiles"]
): CircularImport[] {
