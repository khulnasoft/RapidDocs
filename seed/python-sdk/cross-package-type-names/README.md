...
[![pypi](https://img.shields.io/pypi/v/rapiddocs_cross-package-type-names)](https://pypi.python.org/pypi/rapiddocs_cross-package-type-names)
...
```sh
pip install rapiddocs_cross-package-type-names
```
