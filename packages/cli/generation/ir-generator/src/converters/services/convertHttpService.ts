...
import { RawSchemas, isVariablePathParameter } from "@khulnasoft/rapiddocs-definition-schema";
import {
    Encoding,
    HttpEndpoint,
    HttpHeader,
...
import { constructHttpPath } from "@khulnasoft/ir-utils";
...
export function convertHttpService({
    ...
    const serviceName = { rapiddocsFilepath: file.rapiddocsFilepath };
...
export function resolvePathParameterOrThrow({
    ...
    variableResolver: VariableResolver;
    file: RapiddocsFileContext;
}): { rawType: string; file: RapiddocsFileContext } {
...
export function resolvePathParameter({
    ...
    variableResolver: VariableResolver;
    file: RapiddocsFileContext;
}): { rawType: string; file: RapiddocsFileContext } | undefined {
