...
class ErrorGenerator:
    ...
    def generate(
        ...
        source_file.add_class_declaration(
            declaration=AST.ClassDeclaration(
                ...
                extends=[self._context.core_utilities.exceptions.RapiddocsHTTPException.get_reference_to()],
    ...
    def _write_constructor_body(self, writer: AST.NodeWriter) -> None:
        writer.write_node(
            self._context.core_utilities.exceptions.RapiddocsHTTPException.create(
