...
import com.rapiddocs.ir.model.http.BytesResponse;
import com.rapiddocs.ir.model.http.CursorPagination;
import com.rapiddocs.ir.model.http.FileDownloadResponse;
import com.rapiddocs.ir.model.http.HttpEndpoint;
import com.rapiddocs.ir.model.http.HttpResponseBody;
import com.rapiddocs.ir.model.http.JsonResponse;
import com.rapiddocs.ir.model.http.JsonResponseBody;
import com.rapiddocs.ir.model.http.JsonResponseBodyWithProperty;
import com.rapiddocs.ir.model.http.JsonStreamChunk;
import com.rapiddocs.ir.model.http.OffsetPagination;
import com.rapiddocs.ir.model.http.Pagination;
import com.rapiddocs.ir.model.http.QueryParameter;
import com.rapiddocs.ir.model.http.RequestPropertyValue;
import com.rapiddocs.ir.model.http.SseStreamChunk;
import com.rapiddocs.ir.model.http.StreamParameterResponse;
import com.rapiddocs.ir.model.http.StreamingResponse;
import com.rapiddocs.ir.model.http.TextResponse;
import com.rapiddocs.ir.model.http.TextStreamChunk;
...
import com.rapiddocs.ir.model.types.NamedType;
...
import com.rapiddocs.ir.model.types.UndiscriminatedUnionTypeDeclaration;
import com.rapiddocs.ir.model.types.UnionTypeDeclaration;
...
import com.rapiddocs.java.utils.ObjectMapperUtils;
import com.rapiddocs.java.utils.TypeReferenceUtils;
...
public abstract class AbstractHttpResponseParserGenerator {
        ...
        if (httpEndpoint.getResponse().isPresent()
            ...
            return httpEndpoint.getResponse().get().getBody().get().visit(new HttpResponseBody.Visitor<TypeName>() {
                    ...
                    if (pagination) {
                        ...
                        return httpEndpoint.getPagination().get().visit(new Pagination.Visitor<TypeName>() {
                            ...
                            public TypeName visitCursor(CursorPagination cursor) {
                                ...
                                com.rapiddocs.ir.model.types.ContainerType resultContainerType = resultSnippet
                                        .typeReference
                                        .getContainer()
                                        .orElseThrow(() -> new RuntimeException(
                                                "Unexpected non-container pagination result type"));
                                com.rapiddocs.ir.model.types.TypeReference resultUnderlyingType = resultContainerType.visit(
                ...
                public TypeName visitStreaming(StreamingResponse streaming) {
                    com.rapiddocs.ir.model.types.TypeReference bodyType = streaming.visit(new StreamingResponse.Visitor<>() {
                        @Override
                        public com.rapiddocs.ir.model.types.TypeReference visitJson(JsonStreamChunk json) {
                            return json.getPayload();
                        }

                        @Override
                        public com.rapiddocs.ir.model.types.TypeReference visitText(TextStreamChunk text) {
                            throw new RuntimeException("Returning streamed text is not supported.");
                        }

                        @Override
                        public com.rapiddocs.ir.model.types.TypeReference visitSse(SseStreamChunk sse) {
                            return sse.getPayload();
                        }

                        @Override
                        public com.rapiddocs.ir.model.types.TypeReference _visitUnknown(Object unknownType) {
                            throw new RuntimeException("Encountered unknown json response body type: " + unknownType);
                        }
                    });
    ...
    private SnippetAndResultType getNestedPropertySnippet(
            ...
            com.rapiddocs.ir.model.types.TypeReference typeReference) {
    ...
    private class SnippetAndResultType {
        private final com.rapiddocs.ir.model.types.TypeReference typeReference;
        private final TypeName typeName;
        private final CodeBlock codeBlock;

        private SnippetAndResultType(
                com.rapiddocs.ir.model.types.TypeReference typeReference, TypeName typeName, CodeBlock codeBlock) {
    ...
    private class NestedPropertySnippetGenerator
            implements com.rapiddocs.ir.model.types.TypeReference.Visitor<GetSnippetOutput> {
        ...
        private final Optional<com.rapiddocs.ir.model.types.TypeReference> previousTypeReference;
        ...
        private NestedPropertySnippetGenerator(
                ...
                Optional<com.rapiddocs.ir.model.types.TypeReference> previousTypeReference,
                ClientGeneratorContext clientGeneratorContext) {
            this.typeReference = typeReference;
        ...
        private CodeBlock getterCodeBlock(Name property, com.rapiddocs.ir.model.types.TypeReference overrideTypeReference) {
        ...
        @Override
        public GetSnippetOutput visitContainer(com.rapiddocs.ir.model.types.ContainerType container) {
            ...
            com.rapiddocs.ir.model.types.TypeReference ref = container
                    .getOptional()
                    .orElseThrow(
                    ...
                    if (propertyPath.isEmpty()) {
                        if (currentOptional || previousWasOptional) {
                            return new GetSnippetOutput(
                                    com.rapiddocs.ir.model.types.TypeReference.container(
                                            com.rapiddocs.ir.model.types.ContainerType.optional(typeReference)),
                                    codeBlocks);
                        }
                        return new GetSnippetOutput(typeReference, codeBlocks);
                    }
                        ...
                        for (DeclaredTypeName declaredTypeName : object.getExtends()) {
                            try {
                                return visitNamed(NamedType.builder()
                                        ...
                                        .rapiddocsFilepath(declaredTypeName.getRapiddocsFilepath())
    ...
    private class GetSnippetOutput {
        ...
        private GetSnippetOutput(com.rapiddocs.ir.model.types.TypeReference typeReference, List<CodeBlock> code) {
            this.typeReference = typeReference;
            this.code = code;
        }
    }
    ...
    private final class JsonResponsePaginationVisitor implements Pagination.Visitor<Void> {
                ...
                if (nextSnippet.typeReference.getContainer().get().isOptional()) {
                    ...
                    throw new IllegalStateException(
                            "Found non-optional container as next page token. This should be impossible "
                                    + "due to rapiddocs check validation.");
                }
        ...
        public Void visitOffset(OffsetPagination offset) {
            com.rapiddocs.ir.model.types.TypeReference pageType = offset.getPage()
                    .getProperty()
                    .visit(new RequestPropertyValue.Visitor<com.rapiddocs.ir.model.types.TypeReference>() {
                        @Override
                        public com.rapiddocs.ir.model.types.TypeReference visitQuery(QueryParameter queryParameter) {
                            return queryParameter.getValueType();
                        }

                        @Override
                        public com.rapiddocs.ir.model.types.TypeReference visitBody(ObjectProperty objectProperty) {
                            return objectProperty.getValueType();
                        }

                        @Override
                        public com.rapiddocs.ir.model.types.TypeReference _visitUnknown(Object o) {
                            throw new IllegalArgumentException("Unknown request property value type.");
                        }
                    });
            ...
            com.rapiddocs.ir.model.types.TypeReference numberType = pageType.getContainer()
