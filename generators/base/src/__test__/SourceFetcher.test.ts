...
import { AbstractGeneratorContext } from "@khulnasoft/browser-compatible-base-generator";
import { AbsoluteFilePath, getDirectoryContents, getDirectoryContentsForSnapshot } from "@khulnasoft/fs-utils";

import { SourceFetcher } from "../SourceFetcher";

const AWS_BUCKET_NAME = "fdr-api-definition-source-test";
const AWS_OBJECT_KEY = "rapiddocs/rapiddocs/2024-08-11T22:35:49.980Z/f6ea473b-1884-4ccc-b386-113cbff139d1";
