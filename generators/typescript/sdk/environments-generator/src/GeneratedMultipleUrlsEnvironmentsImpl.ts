import { RapiddocsWriters, getTextOfTsNode } from "@rapiddocs-typescript/commons";
import { GeneratedEnvironments, SdkContext } from "@rapiddocs-typescript/contexts";
...
export class GeneratedMultipleUrlsEnvironmentsImpl implements GeneratedEnvironments {
    ...
    public writeToFile(context: SdkContext): void {
        ...
        const objectWriter = RapiddocsWriters.object.writer({ asConst: true });
