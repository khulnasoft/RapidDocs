...
Rapiddocs allows you to fine-tune your SDK method and group names so that
...
If you're using an OpenAPI Specification, you'll need to leverage the [`x-rapiddocs-sdk-method-name`](/learn/api-definition/openapi/extensions#sdk-method-names)
extension. If you're using the rapiddocs definition, then the method name comes from the endpoint directly.

## Casing

Additionally, Rapiddocs handles choosing the appropriate casing for each SDK
