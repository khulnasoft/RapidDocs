...
import (
	json "encoding/json"
	fmt "fmt"
	internal "github.com/khulnasoft/rapiddocs-go/internal/testdata/model/undiscriminated/fixtures/internal"
	time "time"
)

type AnotherUnion struct {
	String            string
	RapiddocsStringLiteral string
	Foo               *Foo
...
func NewAnotherUnionWithRapiddocsStringLiteral() *AnotherUnion {
	return &AnotherUnion{typ: "RapiddocsStringLiteral", RapiddocsStringLiteral: "rapiddocs"}
}
...
func (a *AnotherUnion) UnmarshalJSON(data []byte) error {
	...
	var valueRapiddocsStringLiteral string
	if err := json.Unmarshal(data, &valueRapiddocsStringLiteral); err == nil {
		a.typ = "RapiddocsStringLiteral"
		a.RapiddocsStringLiteral = valueRapiddocsStringLiteral
		if a.RapiddocsStringLiteral != "rapiddocs" {
			return fmt.Errorf("unexpected value for literal on type %T; expected %v got %v", a, "rapiddocs", valueRapiddocsStringLiteral)
		}
		return nil
	}
	valueFoo := new(Foo)
...
func (a AnotherUnion) MarshalJSON() ([]byte, error) {
	...
	if a.typ == "RapiddocsStringLiteral" || a.RapiddocsStringLiteral != "" {
		return json.Marshal("rapiddocs")
	}
...
type AnotherUnionVisitor interface {
	...
	VisitRapiddocsStringLiteral(string) error
	VisitFoo(*Foo) error
}
...
func (a *AnotherUnion) Accept(visitor AnotherUnionVisitor) error {
	...
	if a.typ == "RapiddocsStringLiteral" || a.RapiddocsStringLiteral != "" {
		return visitor.VisitRapiddocsStringLiteral(a.RapiddocsStringLiteral)
	}
	if a.typ == "Foo" || a.Foo != nil {
...
func NewUnionWithRapiddocsStringLiteral() *Union {
	return &Union{typ: "RapiddocsStringLiteral", RapiddocsStringLiteral: "rapiddocs"}
}
...
func (u *Union) UnmarshalJSON(data []byte) error {
	...
	var valueRapiddocsStringLiteral string
	if err := json.Unmarshal(data, &valueRapiddocsStringLiteral); err == nil {
		u.typ = "RapiddocsStringLiteral"
		u.RapiddocsStringLiteral = valueRapiddocsStringLiteral
		if u.RapiddocsStringLiteral != "rapiddocs" {
			return fmt.Errorf("unexpected value for literal on type %T; expected %v got %v", u, "rapiddocs", valueRapiddocsStringLiteral)
		}
		return nil
	}
...
func (u Union) MarshalJSON() ([]byte, error) {
	...
	if u.typ == "RapiddocsStringLiteral" || u.RapiddocsStringLiteral != "" {
		return json.Marshal("rapiddocs")
	}
...
func (u *Union) Accept(visitor UnionVisitor) error {
	...
	if u.typ == "RapiddocsStringLiteral" || u.RapiddocsStringLiteral != "" {
		return visitor.VisitRapiddocsStringLiteral(u.RapiddocsStringLiteral)
	}
	if u.typ == "AnotherStringLiteral" || u.AnotherStringLiteral != "" {
...
func NewUnionWithLiteralWithRapiddocsStringLiteral() *UnionWithLiteral {
	return &UnionWithLiteral{typ: "RapiddocsStringLiteral", RapiddocsStringLiteral: "rapiddocs"}
}
