import { RapiddocsGeneratorExec, GeneratorNotificationService } from "@khulnasoft/base-generator";
import { AbstractCsharpGeneratorCli, validateReadOnlyMemoryTypes } from "@khulnasoft/csharp-codegen";
