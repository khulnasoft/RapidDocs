...
Rapiddocs generates code snippets of how to consume the SDK in various languages. 
...
If you use Rapiddocs to generate your developer documentation, then you can configure the code 
snippets to be automatically populated in your documentation.

<Frame caption="Automatically populated code snippets">
  ![Code snippets](https://rapiddocs-image-hosting.s3.amazonaws.com/rapiddocs/sdk-code-snippets-in-docs.png)
</Frame>
...
<Frame caption="merge.dev uses the snippets API to populate their documentation">
  ![Code snippets](https://rapiddocs-image-hosting.s3.amazonaws.com/rapiddocs/merge-code-snippets.png)
</Frame>
