...
`;
        ...
        const { links } = collectLinksAndSources({
            content,
            absoluteFilepath: AbsoluteFilePath.of("/path/to/rapiddocs/file0.md")
        });
          ...
          [
            {
              ...
              "sourceFilepath": "/path/to/rapiddocs/file0.md",
            },
            {
              "href": "./file2.js",
              "position": {
    ...
    it("should trace imports to other markdown files", () => {
        ...
        const { links } = collectLinksAndSources({
            content,
            absoluteFilepath: AbsoluteFilePath.of("/path/to/rapiddocs/file0.mdx"),
            readFile: (path) => {
                if (path === AbsoluteFilePath.of("/path/to/rapiddocs/file1.mdx")) {
    ...
    it("should throw if there is a circular import", () => {
        ...
        }).toThrow("Circular import detected: /path/to/rapiddocs/file1.mdx");
    });
