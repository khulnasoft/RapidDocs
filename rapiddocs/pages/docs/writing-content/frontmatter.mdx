...
```yaml title="docs.yml"
title: Rapiddocs | Documentation  # Site-wide title suffix
navigation:
...
- With frontmatter: "Welcome to our docs - Rapiddocs | Documentation"
- Without frontmatter: "Welcome - Rapiddocs | Documentation"
...
<ParamField path="edit-this-page-url" type="string" required={false}>
  Provide the absolute link to the source `.md` or `.mdx` file in GitHub. Rapiddocs uses it to add an `Edit this page` link to the page, which users of your documentation can use to suggest corrections or additions. You can also configure this globally instead of page-by-page - see [global configuration](/learn/docs/getting-started/global-configuration#edit-this-page).
</ParamField>
...
When the table of contents is hidden, Rapiddocs will center the contents of the page by default. To control the layout of the page, see the [layout documentation](#layout).
...
<ParamField path="canonical-url" type="string" required={false}>
  Overrides the canonical URL for this page. Must be a full URL including the protocol (i.e. `https://buildwithrapiddocs.com/learn/docs/content/frontmatter`)
</ParamField>
