...
export type RapiddocsStreamingExtension = OnlyStreamingEndpoint | StreamConditionEndpoint;
...
export function getRapiddocsStreamingExtension(operation: OpenAPIV3.OperationObject): RapiddocsStreamingExtension | undefined {
    const streaming = getExtension<Raw.StreamingExtensionSchema>(operation, RapiddocsOpenAPIExtension.STREAMING);
