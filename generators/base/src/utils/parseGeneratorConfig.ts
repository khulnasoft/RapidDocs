...
import { RapiddocsGeneratorExec, GeneratorExecParsing } from "@khulnasoft/browser-compatible-base-generator";

export async function parseGeneratorConfig(pathToConfig: string): Promise<RapiddocsGeneratorExec.GeneratorConfig> {
