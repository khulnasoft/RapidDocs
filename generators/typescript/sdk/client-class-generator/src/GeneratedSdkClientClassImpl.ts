...
import { GeneratedEndpointImplementation, GeneratedSdkClientClass, SdkContext } from "@rapiddocs-typescript/contexts";
import { ErrorResolver, PackageResolver } from "@rapiddocs-typescript/resolvers";
import {
...
import { SetRequired, assertNever } from "@khulnasoft/core-utils";
...
export class GeneratedSdkClientClassImpl implements GeneratedSdkClientClass {
    ...
    public accessFromRootClient(args: { referenceToRootClient: ts.Expression }): ts.Expression {
        return [...this.package_.rapiddocsFilepath.allParts].reduce<ts.Expression>(
    ...
    public getHeaders(context: SdkContext): GeneratedHeader[] {
        ...
        headers.push(
            {
                header: "X-Rapiddocs-Runtime",
                value: context.coreUtilities.runtime.type._getReferenceTo()
            },
            {
                header: "X-Rapiddocs-Runtime-Version",
