import { WriteablePythonFile, core, dt, pydantic } from "@khulnasoft/base-python-generator";
...
import { AliasTypeDeclaration, PrimitiveTypeV1, TypeDeclaration, TypeId, TypeReference } from "@rapiddocs-rapiddocs/ir-sdk/api";
