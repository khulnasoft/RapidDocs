...
import { assertNever, isPlainObject } from "@khulnasoft/core-utils";
import {
    RawSchemas,
...
export function convertTypeExample({
    ...
    fileContainingType: RapiddocsFileContext;
    fileContainingExample: RapiddocsFileContext;
...
export function convertTypeReferenceExample({
    ...
    fileContainingRawTypeReference: RapiddocsFileContext;
    typeResolver: TypeResolver;
    exampleResolver: ExampleResolver;
    workspace: RapiddocsWorkspace;
}): ExampleTypeReference {
        ...
        visitor: {
            ...
            named: (named) => {
                ...
                const typeName: DeclaredTypeName = {
                    ...
                    rapiddocsFilepath: parsedReferenceToNamedType.rapiddocsFilepath,
...
function getOriginalTypeDeclarationForProperty({
    ...
    | { typeName: DeclaredTypeName; rawPropertyType: string | RawSchemas.ObjectPropertySchema; file: RapiddocsFileContext }
    | undefined {
    ...
    switch (parsedSingleUnionTypeProperties.propertiesType) {
        ...
        case "samePropertiesAsObject": {
            ...
            const typeName: DeclaredTypeName = {
                ...
                rapiddocsFilepath: parsedSingleUnionTypeProperties.rapiddocsFilepath,
