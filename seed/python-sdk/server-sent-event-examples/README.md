...
[![pypi](https://img.shields.io/pypi/v/rapiddocs_server-sent-event-examples)](https://pypi.python.org/pypi/rapiddocs_server-sent-event-examples)
...
```sh
pip install rapiddocs_server-sent-event-examples
```
