...
from rapiddocs_python.codegen.ast.nodes.reference_node.reference_node import ReferenceNode
from rapiddocs_python.codegen.ast.references.module import Module
from rapiddocs_python.codegen.ast.references.reference import Reference, ReferenceImport
from rapiddocs_python.codegen.filepath import Filepath
from rapiddocs_python.codegen.project import Project
from rapiddocs_python.codegen.source_file import SourceFile
from rapiddocs_python.generator_exec_wrapper.generator_exec_wrapper import (
...
from rapiddocs_python.generators.sdk.environment_generators.multiple_base_urls_environment_generator import (
    MultipleBaseUrlsEnvironmentGenerator,
)
from rapiddocs_python.generators.sdk.environment_generators.single_base_url_environment_generator import (
    SingleBaseUrlEnvironmentGenerator,
)
from rapiddocs_python.snippet.snippet_writer import SnippetWriter
from rapiddocs_python.source_file_factory.source_file_factory import SourceFileFactory
...
class SnippetTestFactory:
    ...
    def _get_filepath_for_rapiddocs_filepath(self, rapiddocs_filepath: ir_types.RapiddocsFilepath) -> Filepath:
        ...
        for pathpart in rapiddocs_filepath.package_path:
            directories += (
                Filepath.DirectoryFilepathPart(
        ...
        module_name = rapiddocs_filepath.file.snake_case.safe_name if rapiddocs_filepath.file is not None else "root"
        return Filepath(
    ...
    def _generate_service_test(self, service: ir_types.HttpService, snippet_writer: SnippetWriter) -> None:
        ...
        filepath = self._get_filepath_for_rapiddocs_filepath(rapiddocs_filepath)
