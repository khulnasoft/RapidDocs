...
import { ReleaseType } from "@rapiddocs-rapiddocs/generators-sdk/api/resources/generators";

import { CliContext } from "../CliContext";

export interface RapiddocsGeneratorUpgradeInfo {
...
export function processGeneratorGroups(
    ...
    logger: Logger
): RapiddocsGeneratorUpgradeInfo[] {
    const upgradeInfo: RapiddocsGeneratorUpgradeInfo[] = [];
...
export async function getProjectGeneratorUpgrades({
    ...
    channel?: ReleaseType;
    includeMajor?: boolean;
}): Promise<RapiddocsGeneratorUpgradeInfo[]> {
    const generatorUpgrades: RapiddocsGeneratorUpgradeInfo[] = [];
    if (project != null) {
