...
from rapiddocs_python.codegen import AST, Filepath, Project
from rapiddocs_python.external_dependencies import FastAPI, Starlette
...
class RegisterFileGenerator:
    ...
    def _write_register_method_body(self, writer: AST.NodeWriter) -> None:
        ...
        self._write_exception_handler(
            writer=writer,
            exception_type=self._context.core_utilities.exceptions.RapiddocsHTTPException.get_reference_to(),
            handler=self._context.core_utilities.exceptions.rapiddocs_http_exception_handler(),
        )
        self._write_exception_handler(
            writer=writer,
            ...
            signature=AST.FunctionSignature(
                parameters=[
                    AST.FunctionParameter(
                        ...
                        type_hint=AST.TypeHint(type=self._context.core_utilities.AbstractRapiddocsService()),
                    ),
                ],
    ...
    def _write_register_service_method_body(self, writer: AST.NodeWriter) -> None:
        ...
        writer.write_line(
            ...
            + f"{self._context.core_utilities.INIT_RAPIDDOCS_METHOD_NAME}"
