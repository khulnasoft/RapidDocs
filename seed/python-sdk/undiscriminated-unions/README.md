...
[![pypi](https://img.shields.io/pypi/v/rapiddocs_undiscriminated-unions)](https://pypi.python.org/pypi/rapiddocs_undiscriminated-unions)
...
```sh
pip install rapiddocs_undiscriminated-unions
```
