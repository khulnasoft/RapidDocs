...
import com.rapiddocs.ir.model.commons.SubpackageId;
...
import com.rapiddocs.java.client.generators.endpoint.HttpEndpointMethodSpecs;
...
public abstract class AbstractClientGeneratorUtils {
    ...
    private final IPackage rapiddocsPackage;
    ...
    public AbstractClientGeneratorUtils(
        ...
        this.clientOptionsField = FieldSpec.builder(generatedClientOptions.getClassName(), "clientOptions")
                ...
                .build();
        this.rapiddocsPackage = rapiddocsPackage;
    ...
    public Result buildClients() {
        Optional<HttpService> maybeHttpService = rapiddocsPackage
                .getService()
        ...
        for (SubpackageId subpackageId : rapiddocsPackage.getSubpackages()) {
