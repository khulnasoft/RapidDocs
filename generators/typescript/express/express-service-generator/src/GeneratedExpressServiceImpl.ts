import { PackageId, convertHttpPathToExpressRoute, getTextOfTsNode, maybeAddDocsNode } from "@rapiddocs-typescript/commons";
import { ExpressContext, GeneratedExpressService } from "@rapiddocs-typescript/contexts";
            ...
            ts.factory.createCallExpression(
                ...
                [
                    ts.factory.createBinaryExpression(
                        ...
                        ts.factory.createToken(ts.SyntaxKind.PlusToken),
                        ts.factory.createStringLiteral(" the endpoint's errors list in your Rapiddocs Definition.")
                    )
                ]
            )
        );
