        ...
        (yargs) =>
            yargs
                ...
                .option("path", {
                    ...
                    string: true,
                    demandOption: true,
                    description: "Path to the rapiddocs definition"
                })
                .option("log-level", {
                    default: LogLevel.Info,
                    choices: LOG_LEVELS
...
function addGenerateCommands(cli: Argv) {
    cli.command("generate", "generate artifacts based on your seed declarations", (yargs) => {
        yargs.command("changelog", "generate a changelog in the Rapiddocs Docs format", (tlYargs) => {
            tlYargs
                .command(
                    "cli",
...
// Dummy clone of the function from @khulnasoft/core
