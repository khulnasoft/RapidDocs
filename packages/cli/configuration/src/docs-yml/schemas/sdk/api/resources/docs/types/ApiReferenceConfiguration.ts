...
export interface ApiReferenceConfiguration extends RapiddocsDocsConfig.WithPermissions, RapiddocsDocsConfig.WithFeatureFlags {
    api: string;
    /** Name of API that we are referencing */
    apiName?: string;
    /** Path to an openrpc spec. */
    openrpc?: string;
    audiences?: RapiddocsDocsConfig.AudienceId[];
    /** Defaults to false */
    displayErrors?: boolean;
    snippets?: RapiddocsDocsConfig.SnippetsConfiguration;
    /** Relative path to the markdown file */
    summary?: string;
    /** Advanced usage: when specified, this object will be used to customize the order that your API endpoints are displayed in the docs site, including subpackages, and additional markdown pages (to be rendered in between API endpoints). If not specified, the order will be inferred from the OpenAPI Spec or Rapiddocs Definition. */
    layout?: RapiddocsDocsConfig.ApiReferenceLayoutItem[];
    icon?: string;
    slug?: string;
    hidden?: boolean;
    skipSlug?: boolean;
