...
import { RapiddocsDefinitionBuilder, RapiddocsDefinitionBuilderImpl } from "@khulnasoft/importer-commons";
...
import { isSchemaEqual } from "@khulnasoft/openapi-ir";
...
export class OpenApiIrConverterContext {
    ...
    public builder: RapiddocsDefinitionBuilder;
    ...
    constructor({
        ...
        this.builder = new RapiddocsDefinitionBuilderImpl(this.enableUniqueErrorsPerEndpoint);
        if (ir.title != null) {
