...
from rapiddocs_python.generators.pydantic_model.typeddict import RapiddocsTypedDict
...
class TypeddictObjectSnippetGenerator(AbstractObjectSnippetGenerator):
    ...
    def generate_snippet(self) -> AST.Expression:
        return RapiddocsTypedDict.type_to_snippet(example=self.example, snippet_writer=self.snippet_writer)
