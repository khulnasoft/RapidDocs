...
import { ExampleGenerator } from "@khulnasoft/rapiddocs-csharp-model";

import { ExampleEndpointCall, ExampleRequestBody, HttpEndpoint, PathParameter, ServiceId } from "@rapiddocs-rapiddocs/ir-sdk/api";
...
export abstract class AbstractEndpointGenerator {
    ...
    protected generateEndpointSnippet({
        ...
        const serviceFilePath = service.name.rapiddocsFilepath;
