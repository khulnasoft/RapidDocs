...
const (
	...
	// generated SDK.
	localFileGenerationDocsLink = "https://github.com/khulnasoft/rapiddocs-go#local-file-generation"
...
// the commands (e.g. rapiddocs-go-{client,model}).
type Config struct {
	DryRun                       bool
...
func Run(usage string, fn GeneratorFunc) {
	if len(os.Args) == 2 && (os.Args[1] == "--version" || os.Args[1] == "-v") {
		fmt.Fprintln(os.Stdout, rapiddocs.Version)
		os.Exit(0)
	}
