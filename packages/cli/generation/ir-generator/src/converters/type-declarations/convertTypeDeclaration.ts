...
import { RawSchemas, isRawObjectDefinition, visitRawTypeDeclaration } from "@khulnasoft/rapiddocs-definition-schema";
import { Encoding, ExampleType, RapiddocsFilepath, Source, Type, TypeDeclaration } from "@khulnasoft/ir-sdk";
...
export function convertTypeDeclaration({
    ...
    return {
        ...
        descendantFilepaths: new Set(referencedTypes.map((referencedType) => referencedType.rapiddocsFilepath))
    };
}
