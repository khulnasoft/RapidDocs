...
import { HttpEndpoint, IntermediateRepresentation } from "@khulnasoft/ir-sdk";
...
export class MockServer {
    ...
    public async start(): Promise<number> {
        ...
        this.context.logger.info(`Running Rapiddocs mock server on localhost: ${this.port}`);
        return this.port;
    }
...
function getFullPathForEndpoint(endpoint: HttpEndpoint): string {
    ...
    for (const part of endpoint.fullPath.parts) {
        // Unlike the Rapiddocs IR, express expects the ':'
