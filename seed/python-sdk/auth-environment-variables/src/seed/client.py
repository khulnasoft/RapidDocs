...
class SeedAuthEnvironmentVariables:
    ...
    def __init__(
        ...
        *,
        ...
        api_key: typing.Optional[str] = os.getenv("RAPIDDOCS_API_KEY"),
        ...
        if api_key is None:
            raise ApiError(body="The client must be instantiated be either passing in api_key or setting RAPIDDOCS_API_KEY")
