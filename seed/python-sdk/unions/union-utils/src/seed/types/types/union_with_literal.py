...
class _Factory:
    def rapiddocs(self, value: typing.Literal["rapiddocs"]) -> UnionWithLiteral:
        if IS_PYDANTIC_V2:
            return UnionWithLiteral(root=_UnionWithLiteral.Rapiddocs(type="rapiddocs", value=value))  # type: ignore
        else:
            return UnionWithLiteral(__root__=_UnionWithLiteral.Rapiddocs(type="rapiddocs", value=value))  # type: ignore
...
class UnionWithLiteral(UniversalRootModel):
    ...
    def visit(self, rapiddocs: typing.Callable[[typing.Literal["rapiddocs"]], T_Result]) -> T_Result:
