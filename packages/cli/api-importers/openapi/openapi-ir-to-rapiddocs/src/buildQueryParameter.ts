...
import { QueryParameter, Schema, VALID_ENUM_NAME_REGEX, generateEnumNameFromValue } from "@khulnasoft/openapi-ir";
        ...
        if (resolvedSchema == null) {
            ...
            return {
                value: buildTypeReference({
                    ...
                    context,
                    declarationFile: RelativeFilePath.of(RAPIDDOCS_PACKAGE_MARKER_FILENAME),
                    fileContainingReference,
                    namespace,
                    declarationDepth: 0
                }),
