...
export class ExampleGenerator {
    ...
    public registerSnippet(func: Function_, endpoint: HttpEndpoint): void {
        ...
        if (funcExample != null) {
            ...
            this.endpointSnippets.push({
                id: {
                    path: RapiddocsGeneratorExec.EndpointPath(this.getFullPathForEndpoint(endpoint)),
                    method: endpoint.method,
                    identifierOverride: endpoint.id
                },
                snippet: RapiddocsGeneratorExec.EndpointSnippet.ruby({
    ...
    public generateSnippetsFile(snippetsPath: string): GeneratedFile {
        ...
        const snippets: RapiddocsGeneratorExec.Snippets = {
