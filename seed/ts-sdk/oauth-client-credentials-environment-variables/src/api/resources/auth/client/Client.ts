    ...
    public async getTokenWithClientCredentials(
        ...
        const _response = await core.fetcher({
            ...
            headers: {
                ...
                "X-Rapiddocs-SDK-Name": "@rapiddocs/oauth-client-credentials-environment-variables",
                "X-Rapiddocs-SDK-Version": "0.0.1",
                "User-Agent": "@rapiddocs/oauth-client-credentials-environment-variables/0.0.1",
