...
import { NodePath, isGeneric, parseGeneric, visitRawTypeDeclaration } from "@khulnasoft/rapiddocs-definition-schema";
...
function getGenericArgumentCounts(workspace: RapiddocsWorkspace): Record<string, number> {
