...
import { Endpoint } from "@rapiddocs-rapiddocs/generator-exec-sdk/api";
...
export class SnippetJsonGenerator {
    ...
    public generate(): RapiddocsGeneratorExec.Snippets {
                ...
                snippet += `\nawait foreach (var item in pager)
{
    // do something with item
        ...
        const endpoints: RapiddocsGeneratorExec.Endpoint[] = [];
            ...
            for (const httpEndpoint of service.endpoints) {
                ...
                for (const endpointSnippet of this.getSnippetsForEndpoint(httpEndpoint.id)) {
                    ...
                    const endpoint: Endpoint = {
                        ...
                        id: {
                            path: RapiddocsGeneratorExec.EndpointPath(this.getFullPathForEndpoint(httpEndpoint)),
                            method: httpEndpoint.method,
                            identifierOverride: httpEndpoint.id
                        },
                        snippet: RapiddocsGeneratorExec.EndpointSnippet.csharp({
