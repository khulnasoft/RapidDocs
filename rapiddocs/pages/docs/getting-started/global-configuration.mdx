...
description: "Learn how to configure your Rapiddocs documentation site with the docs.yml file. Customize colors, typography, layout, analytics and more."
---
...
```yaml docs.yml
# yaml-language-server: $schema=https://schema.buildwithrapiddocs.dev/docs-yml.json
```

This enables real-time schema validation and autocompletion based on our [complete schema](https://github.com/khulnasoft/rapiddocs/blob/09555d587294fd3dc77ceb35f21e8976a5a2b7a2/rapiddocs/apis/docs-yml/definition/docs.yml#L110).

## Core configuration

Every Rapiddocs documentation website requires a `docs.yml` file that contains the core configuration settings. Here are the essential top-level properties you can configure:
...
```yaml docs.yml
instances: 
  - url: plantstore.docs.buildwithrapiddocs.com
...
<ParamField path="instances.url" type="string" required={true}>
  The URL where your Rapiddocs documentation is deployed. Must contain the suffix `docs.buildwithrapiddocs.com`.
</ParamField>
...
<ParamField path="href" type="string" required={false}>
  The url once you click on the button. Example: https://buildwithrapiddocs.com/contact
</ParamField>
  ...
  - url: plantstore.docs.buildwithrapiddocs.com
    ...
    edit-this-page:
      github:
        ...
        repo: plant-store-docs
        branch: production
  - url: plantstore-staging.docs.buildwithrapiddocs.com
    edit-this-page:
      github:
        owner: rapiddocs
        repo: plant-store-docs
...
<ParamField path="github.repo" type="string" required={true}>
  The name of the GitHub repository containing your rapiddocs folder.
</ParamField>
...
See [Vapi's landing page live](https://docs.vapi.ai/) and the associated [Markdown file](https://github.com/VapiAI/docs/blob/main/rapiddocs/welcome.mdx?plain=1).
