...
RAPIDDOCS_CONFIG_KEY = "__rapiddocs"
...
def get_route_args(endpoint_function: typing.Callable[..., typing.Any], *, default_tag: str) -> RouteArgs:
    unwrapped = inspect.unwrap(endpoint_function, stop=(lambda f: hasattr(f, RAPIDDOCS_CONFIG_KEY)))
    route_args = typing.cast(RouteArgs, getattr(unwrapped, RAPIDDOCS_CONFIG_KEY, DEFAULT_ROUTE_ARGS))
...
def route_args(
    ...
    contact the Rapiddocs team!
    """

    def decorator(endpoint_function: T) -> T:
        setattr(
            endpoint_function,
            RAPIDDOCS_CONFIG_KEY,
            RouteArgs(
