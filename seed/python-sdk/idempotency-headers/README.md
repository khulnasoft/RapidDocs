...
[![pypi](https://img.shields.io/pypi/v/rapiddocs_idempotency-headers)](https://pypi.python.org/pypi/rapiddocs_idempotency-headers)
...
```sh
pip install rapiddocs_idempotency-headers
```
