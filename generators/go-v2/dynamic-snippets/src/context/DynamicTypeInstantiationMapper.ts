import { DiscriminatedUnionTypeInstance, Severity } from "@khulnasoft/browser-compatible-base-generator";
...
export class DynamicTypeInstantiationMapper {
    ...
    private convertList({ list, value }: { list: RapiddocsIr.dynamic.TypeReference; value: unknown }): go.TypeInstantiation {
    ...
    private convertMap({ map, value }: { map: RapiddocsIr.dynamic.MapType; value: unknown }): go.TypeInstantiation {
    ...
    private convertNamed({
        ...
        named: RapiddocsIr.dynamic.NamedType;
        value: unknown;
    ...
    private convertObject({
        ...
        object_: RapiddocsIr.dynamic.ObjectType;
        value: unknown;
    }): go.TypeInstantiation {
        const properties = this.context.associateByWireValue({
        ...
        return go.TypeInstantiation.structPointer({
            typeReference: go.typeReference({
                ...
                importPath: this.context.getImportPath(object_.declaration.rapiddocsFilepath)
            }),
    ...
    private convertEnum({ enum_, value }: { enum_: RapiddocsIr.dynamic.EnumType; value: unknown }): go.TypeInstantiation {
        ...
        return go.TypeInstantiation.enum(
            go.typeReference({
                name,
                importPath: this.context.getImportPath(enum_.declaration.rapiddocsFilepath)
            })
        );
    }

    private getEnumValueName({ enum_, value }: { enum_: RapiddocsIr.dynamic.EnumType; value: unknown }): string | undefined {
    ...
    private convertUndiscriminatedUnion({
        ...
        undiscriminatedUnion: RapiddocsIr.dynamic.UndiscriminatedUnionType;
        value: unknown;
    }): go.TypeInstantiation {
    ...
    private findMatchingUndiscriminatedUnionType({
        ...
        undiscriminatedUnion: RapiddocsIr.dynamic.UndiscriminatedUnionType;
        value: unknown;
    }): { valueTypeReference: RapiddocsIr.dynamic.TypeReference; typeInstantiation: go.TypeInstantiation } | undefined {
    ...
    private getUndiscriminatedUnionFieldNameForList({
        ...
        list: RapiddocsIr.dynamic.TypeReference.List;
    }): string | undefined {
    ...
    private getUndiscriminatedUnionFieldNameForMap({ map }: { map: RapiddocsIr.dynamic.MapType }): string | undefined {
    ...
    private getUndiscriminatedUnionFieldNameForOptional({
        ...
        typeReference: RapiddocsIr.dynamic.TypeReference.Optional | RapiddocsIr.dynamic.TypeReference.Nullable;
    }): string | undefined {
    ...
    private getUndiscriminatedUnionFieldNameForSet({
        ...
        set: RapiddocsIr.dynamic.TypeReference.Set;
    }): string | undefined {
    ...
    private getUndiscriminatedUnionFieldNameForLiteral({
        ...
        literal: RapiddocsIr.dynamic.LiteralType;
    }): string | undefined {
        switch (literal.type) {
            case "boolean":
                if (literal.value) {
    ...
    private getUndiscriminatedUnionFieldNameForPrimitive({ primitive }: { primitive: RapiddocsIr.PrimitiveTypeV1 }): string {
        switch (primitive) {
            case "INTEGER":
            case "UINT":
                return "Integer";
    ...
    private convertPrimitive({
        ...
        primitive: RapiddocsIr.PrimitiveTypeV1;
        value: unknown;
        as?: DynamicTypeInstantiationMapper.ConvertedAs;
    }): go.TypeInstantiation {
        switch (primitive) {
