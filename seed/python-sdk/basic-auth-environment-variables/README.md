...
[![pypi](https://img.shields.io/pypi/v/rapiddocs_basic-auth-environment-variables)](https://pypi.python.org/pypi/rapiddocs_basic-auth-environment-variables)
...
```sh
pip install rapiddocs_basic-auth-environment-variables
```
