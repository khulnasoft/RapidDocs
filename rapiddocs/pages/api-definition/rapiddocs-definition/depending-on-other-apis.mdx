...
Rapiddocs allows you to import other APIs into your API.
...
dependencies:
   "@rapiddocs/some-dependency": "0.0.1"
```

Next, you need create a folder in your Rapiddocs Definition to house the dependency. Inside the folder, create a special file
...
export:
  dependency: "@rapiddocs/some-dependency"
```

When you generate the SDK with `rapiddocs generate`, the `__package__.yml` file will
