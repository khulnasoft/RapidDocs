...
export function resolveRootImportPath({
    ...
    config: RapiddocsGeneratorExec.config.GeneratorConfig;
...
function getMajorVersionSuffix({ config }: { config: RapiddocsGeneratorExec.config.GeneratorConfig }): string | undefined {
...
function parseMajorVersion({ config }: { config: RapiddocsGeneratorExec.config.GeneratorConfig }): string | undefined {
...
function getVersion(config: RapiddocsGeneratorExec.GeneratorConfig): string | undefined {
