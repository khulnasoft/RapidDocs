...
import { DynamicSnippetsGenerator } from "@khulnasoft/typescript-dynamic-snippets";
...
export class DynamicSnippetsTypeScriptTestGenerator {
    ...
    constructor(
        ...
        private readonly generatorConfig: RapiddocsGeneratorExec.GeneratorConfig
    ) {
     ...
     */
    private buildGeneratorConfig(config: RapiddocsGeneratorExec.GeneratorConfig): RapiddocsGeneratorExec.GeneratorConfig {
