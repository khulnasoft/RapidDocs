...
import { GENERATORS_CONFIGURATION_FILENAME } from "@khulnasoft/configuration-loader";

import { RapiddocsRegistry } from "@rapiddocs-rapiddocs/generators-sdk";

import { CliContext } from "./cli-context/CliContext";
import { getGeneratorUpgradeMessage } from "./cli-context/upgrade-utils/getRapiddocsUpgradeMessage";
    ...
    cli.command(
        ...
        async (argv) => {
            await cliContext.instrumentPostHogEvent({
                command: "rapiddocs organization",
                properties: {
...
export function addGeneratorCommands(cli: Argv<GlobalCliOptions>, cliContext: CliContext): void {
    cli.command("generator", "Operate on the generators within your Rapiddocs configuration", (yargs) => {
        yargs
            .command(
                "list",
                // Hides the command from the help message
                ...
                (yargs) =>
                    yargs
                        ...
                        .option("generators", {
                            ...
                            type: "array",
                            description:
                                "The type of generator to include in the list, ex: `rapiddocs-typescript-node-sdk`. If omitted, all generators will be listed."
                        })
                        .option("groups", {
                            type: "array",
                            string: true,
                ...
                async (argv) => {
                    await cliContext.instrumentPostHogEvent({
                        command: "rapiddocs generator list",
                        properties: {
                            outputLocation: argv.output
                        }
                    });
            ...
            .command(
                ...
                (yargs) =>
                    yargs
                        .option("generator", {
                            string: true,
                            description: "The type of generator to upgrade, ex: `rapiddocs-typescript-node-sdk`."
                        })
                        .option("group", {
                            string: true,
                            description:
                        ...
                        .option("channel", {
                            demandOption: false,
                            choices: Object.values(RapiddocsRegistry.generators.ReleaseType)
                        })
                        .option("list", {
                            demandOption: false,
                            boolean: true,
                ...
                async (argv) => {
                    await cliContext.instrumentPostHogEvent({
                        command: "rapiddocs generator upgrade",
                        properties: {
            ...
            .command(
                ...
                (yargs) =>
                    yargs
                        ...
                        .option("generator", {
                            string: true,
                            demandOption: true,
                            description: "The name of the generator to get, ex: `rapiddocs-typescript-node-sdk`."
                        })
                        .option("group", {
                            string: true,
                            demandOption: true,
                ...
                async (argv) => {
                    await cliContext.instrumentPostHogEvent({
                        command: "rapiddocs generator get",
                        properties: {
                            generator: argv.generator,
                            version: argv.version,
                            api: argv.api,
