...
[![npm shield](https://img.shields.io/npm/v/@rapiddocs/code-samples)](https://www.npmjs.com/package/@rapiddocs/code-samples)
...
```sh
npm i -s @rapiddocs/code-samples
```
...
```typescript
import { SeedCodeSamplesClient } from "@rapiddocs/code-samples";
...
```typescript
import { SeedCodeSamples } from "@rapiddocs/code-samples";
...
```typescript
import { SeedCodeSamplesError } from "@rapiddocs/code-samples";
