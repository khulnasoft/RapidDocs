...
[![pypi](https://img.shields.io/pypi/v/rapiddocs_multi-url-environment)](https://pypi.python.org/pypi/rapiddocs_multi-url-environment)
...
```sh
pip install rapiddocs_multi-url-environment
```
