...
[![pypi](https://img.shields.io/pypi/v/rapiddocs_single-url-environment-default)](https://pypi.python.org/pypi/rapiddocs_single-url-environment-default)
...
```sh
pip install rapiddocs_single-url-environment-default
```
