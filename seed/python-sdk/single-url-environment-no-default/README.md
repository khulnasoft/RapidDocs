...
[![pypi](https://img.shields.io/pypi/v/rapiddocs_single-url-environment-no-default)](https://pypi.python.org/pypi/rapiddocs_single-url-environment-no-default)
...
```sh
pip install rapiddocs_single-url-environment-no-default
```
