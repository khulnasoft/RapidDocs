...
```yaml docs.yml
announcement:
    message: "🚀 New feature: Announcements are available! (<a href=\"https://buildwithrapiddocs.com/learn/docs/building-your-docs/announcements\" target=\"_blank\">Learn more</a>) 🚀"
```
