...
async function main() {
    await tsup.build({
        ...
        env: {
            ...
            DEFAULT_FDR_ORIGIN: "https://registry-dev2.buildwithrapiddocs.com",
            VENUS_AUDIENCE: "venus-dev",
            LOCAL_STORAGE_FOLDER: ".rapiddocs-dev",
            ...
            CLI_NAME: "rapiddocs-dev",
            CLI_VERSION: process.argv[2] || packageJson.version,
            CLI_PACKAGE_NAME: "@khulnasoft/khulnasoft-dev",
        },
    });
    ...
    await writeFile(
        ...
        JSON.stringify(
            {
                name: "@khulnasoft/khulnasoft-dev",
                version: process.argv[2] || packageJson.version,
                repository: packageJson.repository,
                files: ["cli.cjs"],
                bin: { "rapiddocs-dev": "cli.cjs" }
            },
            undefined,
            2
        )
