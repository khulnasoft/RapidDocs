...
import { DEPENDENCIES_FILENAME } from "@khulnasoft/configuration-loader";
import { assertNever, entries } from "@khulnasoft/core-utils";
import { RelativeFilePath } from "@khulnasoft/fs-utils";
import { WorkspaceLoader, WorkspaceLoaderFailureType } from "@khulnasoft/lazy-rapiddocs-workspace";
...
function handleWorkspaceParserFailureForFile({
    ...
    switch (failure.type) {
        case WorkspaceLoaderFailureType.MISCONFIGURED_DIRECTORY:
            logger.error(
                "Misconfigured rapiddocs directory: please see the docs at https://buildwithrapiddocs.com/learn/api-definition/introduction/what-is-the-rapiddocs-folder"
            );
            break;
