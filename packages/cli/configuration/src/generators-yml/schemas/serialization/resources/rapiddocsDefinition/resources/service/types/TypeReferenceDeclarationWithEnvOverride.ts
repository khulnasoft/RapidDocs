...
export const TypeReferenceDeclarationWithEnvOverride: core.serialization.Schema<
    serializers.rapiddocsDefinition.TypeReferenceDeclarationWithEnvOverride.Raw,
    RapiddocsDefinition.rapiddocsDefinition.TypeReferenceDeclarationWithEnvOverride
