...
export class Service {
    ...
    public async getWithApiKey(requestOptions?: Service.RequestOptions): Promise<string> {
        const _response = await core.fetcher({
            ...
            headers: {
                ...
                "X-Rapiddocs-SDK-Name": "@rapiddocs/auth-environment-variables",
                "X-Rapiddocs-SDK-Version": "0.0.1",
                "User-Agent": "@rapiddocs/auth-environment-variables/0.0.1",
    ...
    protected async _getCustomAuthorizationHeaders() {
        const apiKeyValue = (await core.Supplier.get(this._options.apiKey)) ?? process?.env["RAPIDDOCS_API_KEY"];
        return { "X-RAPIDDOCS-API-KEY": apiKeyValue };
    }
}
