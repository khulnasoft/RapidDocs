---
title: Audiences in Rapiddocs Definition 
subtitle: Use audiences in your Rapiddocs Definition to segment your API for different groups of consumers.
---

Audiences are a useful tool for segmenting your API for different consumers. You can configure your Rapiddocs Docs to publish documentation specific to an `Audience`. You can use [audiences in your OpenAPI Specification](/learn/api-definition/openapi/audiences), too. 
...
The Rapiddocs Definition has a first-class concept for marking different endpoints, types, and properties for different audiences. 

To use audiences in your Rapiddocs Definition, add them to `api.yml`. 
...
If generating Rapiddocs Docs, update your `docs.yml` configuration to include your audiences. 
