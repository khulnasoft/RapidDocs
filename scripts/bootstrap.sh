#!/bin/bash
#
# Bootstrap script used to setup Rapiddocs's development environment.
#
# Usage: ./bootstrap.sh
...
echo "Setting up Rapiddocs's development environment:"
echo "  user: $(whoami)"
echo "  shell: $SHELL"
echo
...
if ! command_exists protoc-gen-openapi; then
    ...
    go install github.com/khulnasoft/protoc-gen-openapi/cmd/protoc-gen-openapi@latest
fi
