...
import { EndpointWithExample, LiteralSchemaValue, SchemaWithExample, Source } from "@khulnasoft/openapi-ir";

import { getGeneratedTypeName } from "../../../../schema/utils/getSchemaName";
import { isReferenceObject } from "../../../../schema/utils/isReferenceObject";
import { AbstractOpenAPIV3ParserContext } from "../../AbstractOpenAPIV3ParserContext";
import { AsyncRapiddocsExtensionSchema } from "../../extensions/getRapiddocsAsyncExtension";
...
export function convertAsyncSyncOperation({
    ...
    asyncExtension: AsyncRapiddocsExtensionSchema;
    source: Source;
