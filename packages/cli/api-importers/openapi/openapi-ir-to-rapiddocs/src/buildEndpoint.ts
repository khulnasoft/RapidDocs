...
import { Endpoint, EndpointExample, Request, Schema, SchemaId } from "@khulnasoft/openapi-ir";
import { RelativeFilePath } from "@khulnasoft/path-utils";

import { OpenApiIrConverterContext } from "./OpenApiIrConverterContext";
import { State } from "./State";
import { buildEndpointExample } from "./buildEndpointExample";
import { ERROR_DECLARATIONS_FILENAME, EXTERNAL_AUDIENCE } from "./buildRapiddocsDefinition";
...
export function buildEndpoint({
    ...
    Object.entries(endpoint.errors).forEach(([statusCode, httpError]) => {
        ...
        const fileContainingReference = RelativeFilePath.of(RAPIDDOCS_PACKAGE_MARKER_FILENAME);
