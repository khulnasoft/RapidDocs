...
import { BasePhpCustomConfigSchema, GLOBAL_NAMESPACE, SELF, php } from "@khulnasoft/php-codegen";
...
> extends AbstractGeneratorContext {
    ...
    public getTraitLocationForTypeId(typeId: TypeId): FileLocation {
        ...
        return this.getFileLocation(typeDeclaration.name.rapiddocsFilepath, TRAITS_DIRECTORY);
    }

    protected getFileLocation(filepath: RapiddocsFilepath, suffix?: string): FileLocation {
