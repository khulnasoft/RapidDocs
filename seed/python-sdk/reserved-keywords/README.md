...
[![pypi](https://img.shields.io/pypi/v/rapiddocs_reserved-keywords)](https://pypi.python.org/pypi/rapiddocs_reserved-keywords)
...
```sh
pip install rapiddocs_reserved-keywords
```
