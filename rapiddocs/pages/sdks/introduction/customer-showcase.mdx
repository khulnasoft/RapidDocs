...
At Rapiddocs, we help businesses build and distribute world-class SDKs that developers love. From startups to global enterprises, our customers trust Rapiddocs to elevate their developer experience and simplify API integration. Below are some of the companies leveraging Rapiddocs to power their SDKs.
...
<span class="rapiddocs-docs-badge large green subtle rounded">Public company</span>

Square trusts Rapiddocs to generate and maintain **7 SDKs**, ensuring their APIs are easily accessible to developers building on any platform.  
...
<span class="rapiddocs-docs-badge large green subtle rounded" style="margin-right: 10px">gRPC</span>
<span class="rapiddocs-docs-badge large green subtle rounded">REST</span>
</div>

Pinecone leverages Rapiddocs to create an SDK that supports **both gRPC and REST**, bridging the gap between broad compatibility and peak performance. 
...
<Tip>
Read about [the first auto-generated SDK](https://buildwithrapiddocs.com/blog/pinecone) with gRPC and REST.
</Tip>
...
<div style={{ display: 'flex', alignItems: 'center' }}>
<span class="rapiddocs-docs-badge large green subtle rounded" style="margin-right: 10px">File uploads</span>
<span class="rapiddocs-docs-badge large green subtle rounded">WebSockets</span>
</div>

ElevenLabs uses Rapiddocs to generate SDKs with advanced capabilities for **file uploads** and **websocket communication**, enabling smooth interactions with their AI-powered audio APIs.  
...
<span class="rapiddocs-docs-badge large green subtle rounded">OAuth</span>

Candid uses Rapiddocs to generate an SDK with built in **OAuth support**, enabling secure and seamless authentication for developers.
...
<span class="rapiddocs-docs-badge large green subtle rounded">SSE</span>

Humanloop uses Rapiddocs to support **server-sent events (SSE)** in their SDKs, allowing developers to build robust AI features with LLMs using best-in-class tooling. 
...
<span class="rapiddocs-docs-badge large green subtle rounded">Integration tests</span>

Abound relies on Rapiddocs to manage a **full suite of integration tests**, ensuring their SDKs and APIs deliver a reliable experience for partners and developers. 
...
Ready to streamline your SDK development? [Get started with Rapiddocs today](https://buildwithrapiddocs.com/contact).  
