...
from rapiddocs_python.codegen.ast.nodes.declarations.function.named_function_parameter import (
...
class ReferencedRequestBodyParameters(AbstractRequestBodyParameters):
    ...
    def get_json_body(self, names_to_deconflict: Optional[List[str]] = None) -> Optional[AST.Expression]:
        if not self.should_inline_request_parameters:
            ...
            if (
            ...
            ) and can_tr_be_rapiddocs_model(request_param_tr, self._context.get_types()):
                ...
                return (
                    ...
                    if can_tr_be_rapiddocs_model(request_param_tr, self._context.get_types())
                    else request_param
                )
