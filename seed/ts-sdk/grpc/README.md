...
[![npm shield](https://img.shields.io/npm/v/@rapiddocs/grpc)](https://www.npmjs.com/package/@rapiddocs/grpc)
...
```typescript
import { SeedApi } from "@rapiddocs/grpc";
...
```typescript
import { SeedApiError } from "@rapiddocs/grpc";
