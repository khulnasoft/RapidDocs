...
import { AbsoluteFilePath, cwd, resolve } from "@khulnasoft/fs-utils";
import { runMintlifyMigration } from "@khulnasoft/mintlify-importer";
...
vi.mock("@khulnasoft/mintlify-importer", () => ({
