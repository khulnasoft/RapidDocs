import { GetReferenceOpts, Reference, getTextOfTsNode } from "@rapiddocs-typescript/commons";
import { BaseContext, BaseGeneratedType } from "@rapiddocs-typescript/contexts";
import { ModuleDeclarationStructure, StatementStructures, WriterFunction, ts } from "ts-morph";

import { ExampleType, ExampleTypeShape, RapiddocsFilepath } from "@rapiddocs-rapiddocs/ir-sdk/api";
...
export abstract class AbstractGeneratedType<Shape, Context extends BaseContext> implements BaseGeneratedType<Context> {
    ...
    protected rapiddocsFilepath: RapiddocsFilepath;
    ...
    constructor({
        ...
        this.docs = docs;
        this.rapiddocsFilepath = rapiddocsFilepath;
