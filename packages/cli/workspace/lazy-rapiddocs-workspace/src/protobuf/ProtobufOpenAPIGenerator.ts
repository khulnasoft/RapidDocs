...
import { createLoggingExecutable } from "@khulnasoft/logging-execa";
...
export class ProtobufOpenAPIGenerator {
    ...
    private async doGenerateLocal({
        ...
        try {
            ...
            this.context.failAndThrow(
                "Missing required dependency; please install 'protoc-gen-openapi' to continue (e.g. 'brew install go && go install github.com/khulnasoft/protoc-gen-openapi/cmd/protoc-gen-openapi@latest')."
            );
        }
