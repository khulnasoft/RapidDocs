...
import { File, GeneratorNotificationService } from "@khulnasoft/base-generator";
import { AbstractCsharpGeneratorCli, TestFileGenerator, validateReadOnlyMemoryTypes } from "@khulnasoft/csharp-codegen";
import {
    generateTests as generateModelTests,
    generateModels,
    generateVersion,
    generateWellKnownProtobufFiles
} from "@khulnasoft/rapiddocs-csharp-model";
...
import * as RapiddocsGeneratorExecSerializers from "@rapiddocs-rapiddocs/generator-exec-sdk/serialization";
import { HttpService, IntermediateRepresentation } from "@rapiddocs-rapiddocs/ir-sdk/api";
    ...
    protected async generate(context: SdkGeneratorContext): Promise<void> {
        ...
        if (context.config.output.snippetFilepath != null) {
            ...
            await writeFile(
                ...
                JSON.stringify(await RapiddocsGeneratorExecSerializers.Snippets.jsonOrThrow(snippets), undefined, 4)
            );
