...
func (r *RequestOptions) cloneHeader() http.Header {
	...
	headers.Set("X-Rapiddocs-SDK-Name", "github.com/khulnasoft/stream-go/v2")
	headers.Set("X-Rapiddocs-SDK-Version", "v2.0.0")
	headers.Set("User-Agent", "github.com/streaming/rapiddocs/v2.0.0")
	return headers
}
