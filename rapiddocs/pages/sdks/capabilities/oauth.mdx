---
title: OAuth
description: Rapiddocs supports OAuth as a first class citizen
---

<Markdown src="/snippets/pro-callout.mdx" />

Rapiddocs supports the OAuth 2.0 authorization framework as a first class citizen. With Rapiddocs, users don't need
to retrieve and manage access tokens manually. Instead, Rapiddocs SDKs will handle the entire OAuth flow.
...
Rapiddocs supports the following OAuth authorization flows:
