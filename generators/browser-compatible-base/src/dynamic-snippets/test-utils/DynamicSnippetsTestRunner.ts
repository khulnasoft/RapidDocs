...
import { AbsoluteFilePath, join } from "@khulnasoft/path-utils";
...
export namespace DynamicSnippetsTestRunner {
    ...
    interface Generator {
        generate: (request: RapiddocsIr.dynamic.EndpointSnippetRequest) => Promise<RapiddocsIr.dynamic.EndpointSnippetResponse>;
    }

    interface TestCase {
        description: string;
        giveRequest: RapiddocsIr.dynamic.EndpointSnippetRequest;
    }
}
...
function formatResult(response: RapiddocsIr.dynamic.EndpointSnippetResponse): string {
