...
from rapiddocs.generator_exec import GeneratorUpdate, LogLevel, LogUpdate, Snippets
from rapiddocs.generator_exec.config import GeneratorConfig

from rapiddocs_python.cli.abstract_generator import AbstractGenerator
from rapiddocs_python.codegen import AST, Project
from rapiddocs_python.codegen.filepath import Filepath
from rapiddocs_python.codegen.module_manager import ModuleExport
from rapiddocs_python.generator_cli import README_FILENAME, GeneratorCli
from rapiddocs_python.generator_cli.generator_cli import REFERENCE_FILENAME
from rapiddocs_python.generator_exec_wrapper import GeneratorExecWrapper
from rapiddocs_python.generators.pydantic_model import PydanticModelGenerator
from rapiddocs_python.generators.sdk import as_is_copier
from rapiddocs_python.generators.sdk.client_generator.endpoint_metadata_collector import (
    EndpointMetadataCollector,
)
from rapiddocs_python.generators.sdk.context.sdk_generator_context import SdkGeneratorContext
from rapiddocs_python.generators.sdk.context.sdk_generator_context_impl import (
    SdkGeneratorContextImpl,
)
from rapiddocs_python.generators.sdk.core_utilities.client_wrapper_generator import (
    ClientWrapperGenerator,
)
from rapiddocs_python.snippet import SnippetRegistry, SnippetWriter
from rapiddocs_python.snippet.snippet_template_factory import SnippetTemplateFactory
from rapiddocs_python.snippet.snippet_test_factory import SnippetTestFactory
from rapiddocs_python.utils import build_snippet_writer
                    ...
                    generator_exec_wrapper.send_update(
                        GeneratorUpdate.factory.log(
                            LogUpdate(
                                ...
                                message=f"Failed to generate README.md. Email support@buildwithrapiddocs.com with the error: \n{e}\n",
                            )
                        )
                    )
                ...
                try:
                    ...
                    generator_exec_wrapper.send_update(
                        GeneratorUpdate.factory.log(
                            LogUpdate(
                                level=LogLevel.DEBUG,
                                message=f"Failed to generate reference.md. Email support@buildwithrapiddocs.com with the error: \n{e}\n",
                            ),
                        )
                    )
