...
export function generateSubpackage(
    ...
    const location = locationGenerator.getLocationFromRapiddocsFilepath(package_.rapiddocsFilepath, "client");
    const moduleBreadcrumbs = getBreadcrumbsFromFilepath(package_.rapiddocsFilepath, clientName);
...
export function generateService(
    ...
    const moduleBreadcrumbs = getBreadcrumbsFromFilepath(service.name.rapiddocsFilepath, clientName);
