...
import { RapiddocsWorkspace, getAllNamedDefinitionFiles } from "@khulnasoft/api-workspace-commons";
...
function doesApiDeclareErrors(workspace: RapiddocsWorkspace): boolean {
