...
export function convertErrorDeclaration({
    ...
    return {
        ...
        name: {
            ...
            rapiddocsFilepath: convertRapiddocsFilepathV1(errorDeclaration.name.rapiddocsFilepath),
            rapiddocsFilepathV2: convertRapiddocsFilepathV2(errorDeclaration.name.rapiddocsFilepath)
        },
