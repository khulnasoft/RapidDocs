...
import { ClassReferenceFactory, Class_, GeneratedRubyFile, LocationGenerator, Module_ } from "@khulnasoft/ruby-codegen";
    ...
    private generateAliasFile(
        ...
        if (shouldGenerate) {
            const rootNode = Module_.wrapInModules({
                ...
                path: typeDeclaration.name.rapiddocsFilepath,
                isType: true
            });
            return new GeneratedRubyFile({
                rootNode,
