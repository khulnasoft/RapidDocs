...
from rapiddocs_python.codegen.ast.ast_node.node_writer import NodeWriter
from rapiddocs_python.external_dependencies import HttpX
from rapiddocs_python.external_dependencies.asyncio import Asyncio
from rapiddocs_python.generators.pydantic_model.model_utilities import can_tr_be_rapiddocs_model
from rapiddocs_python.generators.sdk.client_generator.endpoint_metadata_collector import (
    EndpointMetadata,
    EndpointMetadataCollector,
    ParameterMetadata,
)
from rapiddocs_python.generators.sdk.client_generator.endpoint_response_code_writer import (
    EndpointResponseCodeWriter,
)
from rapiddocs_python.generators.sdk.client_generator.pagination.abstract_paginator import (
...
from rapiddocs_python.generators.sdk.client_generator.streaming.utilities import (
...
class EndpointFunctionGenerator:
    ...
    def _get_subpackage_client_accessor(
        ...
        components = package.rapiddocs_filepath.package_path.copy()
        if package.rapiddocs_filepath.file is not None:
            components += [package.rapiddocs_filepath.file]
        if len(components) == 0:
            return ""
    ...
    def _get_reference_to_query_parameter(self, query_parameter: ir_types.QueryParameter) -> AST.Expression:
        ...
        elif self._context.custom_config.pydantic_config.use_typeddict_requests and can_tr_be_rapiddocs_model(
    ...
    def convert_and_respect_annotation_metadata_raw(
        ...
        if (
            ...
            or not can_tr_be_rapiddocs_model(type_reference, context.get_types())
            or (
